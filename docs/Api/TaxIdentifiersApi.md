...
[**\DigitalRiver\ApiSdk\Model\ListTaxIdentifiers200Response**](../Model/ListTaxIdentifiers200Response.md)
...
```php
retrieveTaxIdentifiers($id): \DigitalRiver\ApiSdk\Model\CustomerTaxIdentifier
```
