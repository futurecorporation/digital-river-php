...
```php
listShipments($created_time, $updated_time, $ending_before, $starting_after, $limit, $ids): \DigitalRiver\ApiSdk\Model\ListShipments200Response
```
...
[**\DigitalRiver\ApiSdk\Model\ListShipments200Response**](../Model/ListShipments200Response.md)
...
```php
retrieveShipments($id): \DigitalRiver\ApiSdk\Model\Shipment
```
...
[**\DigitalRiver\ApiSdk\Model\Shipment**](../Model/Shipment.md)
