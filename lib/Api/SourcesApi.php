...
/**
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createSources'] to see the possible values for this operation
     *
     ...
     */
    public function createSources($credit_source = null, string $contentType = self::contentTypes['createSources'][0])
    {
        list($response) = $this->createSourcesWithHttpInfo($credit_source, $contentType);
        return $response;
    }
     ...
     */
    public function createSourcesWithHttpInfo($credit_source = null, string $contentType = self::contentTypes['createSources'][0])
    {
        $request = $this->createSourcesRequest($credit_source, $contentType);
     ...
     */
    public function createSourcesAsync($credit_source = null, string $contentType = self::contentTypes['createSources'][0])
    {
        return $this->createSourcesAsyncWithHttpInfo($credit_source, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createSourcesAsyncWithHttpInfo($credit_source = null, string $contentType = self::contentTypes['createSources'][0])
    {
        $returnType = '\DigitalRiver\ApiSdk\Model\Source';
        $request = $this->createSourcesRequest($credit_source, $contentType);
     ...
     */
    public function createSourcesRequest($credit_source = null, string $contentType = self::contentTypes['createSources'][0])
    {
        ...
        if (isset($credit_source)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                ...
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($credit_source));
            } else {
                $httpBody = $credit_source;
            }
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['retrieveSources'] to see the possible values for this operation
     *
     * @throws \DigitalRiver\ApiSdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \DigitalRiver\ApiSdk\Model\Source|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors
     */
    public function retrieveSources($id, string $contentType = self::contentTypes['retrieveSources'][0])
    {
        list($response) = $this->retrieveSourcesWithHttpInfo($id, $contentType);
        return $response;
    }
     ...
     * @return array of \DigitalRiver\ApiSdk\Model\Source|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors, HTTP status code, HTTP response headers (array of strings)
     */
    public function retrieveSourcesWithHttpInfo($id, string $contentType = self::contentTypes['retrieveSources'][0])
    {
        $request = $this->retrieveSourcesRequest($id, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveSourcesAsync($id, string $contentType = self::contentTypes['retrieveSources'][0])
    {
        return $this->retrieveSourcesAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveSourcesAsyncWithHttpInfo($id, string $contentType = self::contentTypes['retrieveSources'][0])
    {
        $returnType = '\DigitalRiver\ApiSdk\Model\Source';
        $request = $this->retrieveSourcesRequest($id, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function retrieveSourcesRequest($id, string $contentType = self::contentTypes['retrieveSources'][0])
    {
