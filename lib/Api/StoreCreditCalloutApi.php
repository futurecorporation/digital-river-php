...
/**
    ...
    /**
     * Operation removeStoreCreditsCallout
     *
     * Remove store credit callout
     *
     * @param  string $upstream_id The unique identifier of the store credit (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['removeStoreCreditsCallout'] to see the possible values for this operation
     *
     * @throws \DigitalRiver\ApiSdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function removeStoreCreditsCallout($upstream_id, string $contentType = self::contentTypes['removeStoreCreditsCallout'][0])
    {
        $this->removeStoreCreditsCalloutWithHttpInfo($upstream_id, $contentType);
    }

    /**
     * Operation removeStoreCreditsCalloutWithHttpInfo
     *
     * Remove store credit callout
     *
     * @param  string $upstream_id The unique identifier of the store credit (required)
     ...
     */
    public function removeStoreCreditsCalloutWithHttpInfo($upstream_id, string $contentType = self::contentTypes['removeStoreCreditsCallout'][0])
    {
        $request = $this->removeStoreCreditsCalloutRequest($upstream_id, $contentType);
    ...
    /**
     * Operation removeStoreCreditsCalloutAsync
     *
     * Remove store credit callout
     *
     * @param  string $upstream_id The unique identifier of the store credit (required)
     ...
     */
    public function removeStoreCreditsCalloutAsync($upstream_id, string $contentType = self::contentTypes['removeStoreCreditsCallout'][0])
    {
        return $this->removeStoreCreditsCalloutAsyncWithHttpInfo($upstream_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation removeStoreCreditsCalloutAsyncWithHttpInfo
     *
     * Remove store credit callout
     *
     * @param  string $upstream_id The unique identifier of the store credit (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function removeStoreCreditsCalloutAsyncWithHttpInfo($upstream_id, string $contentType = self::contentTypes['removeStoreCreditsCallout'][0])
    {
        $returnType = '';
        $request = $this->removeStoreCreditsCalloutRequest($upstream_id, $contentType);
    ...
    /**
     * Create request for operation 'removeStoreCreditsCallout'
     *
     * @param  string $upstream_id The unique identifier of the store credit (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['removeStoreCreditsCallout'] to see the possible values for this operation
     *
     ...
     */
    public function removeStoreCreditsCalloutRequest($upstream_id, string $contentType = self::contentTypes['removeStoreCreditsCallout'][0])
    {

        // verify the required parameter 'upstream_id' is set
        if ($upstream_id === null || (is_array($upstream_id) && count($upstream_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $upstream_id when calling removeStoreCreditsCallout'
            );
        }


        $resourcePath = '/checkouts/store-credits/{upstreamId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if ($upstream_id !== null) {
            $resourcePath = str_replace(
                '{' . 'upstreamId' . '}',
                ObjectSerializer::toPathValue($upstream_id),
                $resourcePath
            );
        }
     ...
     *
     * @param  \DigitalRiver\ApiSdk\Model\StoreCreditAuthorizationRequest $store_credit_authorization_request store_credit_authorization_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['storeCreditsCallout'] to see the possible values for this operation
     *
     * @throws \DigitalRiver\ApiSdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \DigitalRiver\ApiSdk\Model\StoreCreditValidationResponse|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors
     */
    public function storeCreditsCallout($store_credit_authorization_request = null, string $contentType = self::contentTypes['storeCreditsCallout'][0])
    {
        list($response) = $this->storeCreditsCalloutWithHttpInfo($store_credit_authorization_request, $contentType);
        return $response;
    }
     ...
     * Store credit callout
     *
     * @param  \DigitalRiver\ApiSdk\Model\StoreCreditAuthorizationRequest $store_credit_authorization_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['storeCreditsCallout'] to see the possible values for this operation
     *
     * @throws \DigitalRiver\ApiSdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     */
    public function storeCreditsCalloutWithHttpInfo($store_credit_authorization_request = null, string $contentType = self::contentTypes['storeCreditsCallout'][0])
    {
        $request = $this->storeCreditsCalloutRequest($store_credit_authorization_request, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\DigitalRiver\ApiSdk\Model\StoreCreditValidationResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\DigitalRiver\ApiSdk\Model\StoreCreditValidationResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\DigitalRiver\ApiSdk\Model\StoreCreditValidationResponse', []),
            ...
            $returnType = '\DigitalRiver\ApiSdk\Model\StoreCreditValidationResponse';
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function storeCreditsCalloutAsync($store_credit_authorization_request = null, string $contentType = self::contentTypes['storeCreditsCallout'][0])
    {
        return $this->storeCreditsCalloutAsyncWithHttpInfo($store_credit_authorization_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function storeCreditsCalloutAsyncWithHttpInfo($store_credit_authorization_request = null, string $contentType = self::contentTypes['storeCreditsCallout'][0])
    {
        $returnType = '\DigitalRiver\ApiSdk\Model\StoreCreditValidationResponse';
        $request = $this->storeCreditsCalloutRequest($store_credit_authorization_request, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function storeCreditsCalloutRequest($store_credit_authorization_request = null, string $contentType = self::contentTypes['storeCreditsCallout'][0])
    {
        ...
        // for model (json/xml)
        if (isset($store_credit_authorization_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($store_credit_authorization_request));
            } else {
                $httpBody = $store_credit_authorization_request;
            }
