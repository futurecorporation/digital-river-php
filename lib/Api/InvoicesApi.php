...
/**
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['attachSourceToInvoice'] to see the possible values for this operation
     *
     ...
     */
    public function attachSourceToInvoice($id, $source_id, string $contentType = self::contentTypes['attachSourceToInvoice'][0])
    {
        list($response) = $this->attachSourceToInvoiceWithHttpInfo($id, $source_id, $contentType);
        return $response;
    }
     ...
     */
    public function attachSourceToInvoiceWithHttpInfo($id, $source_id, string $contentType = self::contentTypes['attachSourceToInvoice'][0])
    {
        $request = $this->attachSourceToInvoiceRequest($id, $source_id, $contentType);
     ...
     */
    public function attachSourceToInvoiceAsync($id, $source_id, string $contentType = self::contentTypes['attachSourceToInvoice'][0])
    {
        return $this->attachSourceToInvoiceAsyncWithHttpInfo($id, $source_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function attachSourceToInvoiceAsyncWithHttpInfo($id, $source_id, string $contentType = self::contentTypes['attachSourceToInvoice'][0])
    {
        $returnType = '\DigitalRiver\ApiSdk\Model\Source';
        $request = $this->attachSourceToInvoiceRequest($id, $source_id, $contentType);
     ...
     */
    public function attachSourceToInvoiceRequest($id, $source_id, string $contentType = self::contentTypes['attachSourceToInvoice'][0])
    {
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createInvoices'] to see the possible values for this operation
     *
     * @throws \DigitalRiver\ApiSdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \DigitalRiver\ApiSdk\Model\Invoice|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors
     */
    public function createInvoices($invoice_request = null, string $contentType = self::contentTypes['createInvoices'][0])
    {
        list($response) = $this->createInvoicesWithHttpInfo($invoice_request, $contentType);
        return $response;
    }
     ...
     * @return array of \DigitalRiver\ApiSdk\Model\Invoice|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors, HTTP status code, HTTP response headers (array of strings)
     */
    public function createInvoicesWithHttpInfo($invoice_request = null, string $contentType = self::contentTypes['createInvoices'][0])
    {
        $request = $this->createInvoicesRequest($invoice_request, $contentType);
            ...
            switch($statusCode) {
                case 201:
                    if ('\DigitalRiver\ApiSdk\Model\Invoice' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\DigitalRiver\ApiSdk\Model\Invoice' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createInvoicesAsync($invoice_request = null, string $contentType = self::contentTypes['createInvoices'][0])
    {
        return $this->createInvoicesAsyncWithHttpInfo($invoice_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createInvoicesAsyncWithHttpInfo($invoice_request = null, string $contentType = self::contentTypes['createInvoices'][0])
    {
        $returnType = '\DigitalRiver\ApiSdk\Model\Invoice';
        $request = $this->createInvoicesRequest($invoice_request, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function createInvoicesRequest($invoice_request = null, string $contentType = self::contentTypes['createInvoices'][0])
    {
     ...
     * @return void
     */
    public function deleteInvoices($id, string $contentType = self::contentTypes['deleteInvoices'][0])
    {
        $this->deleteInvoicesWithHttpInfo($id, $contentType);
    }
     ...
     */
    public function deleteInvoicesWithHttpInfo($id, string $contentType = self::contentTypes['deleteInvoices'][0])
    {
        $request = $this->deleteInvoicesRequest($id, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteInvoicesAsync($id, string $contentType = self::contentTypes['deleteInvoices'][0])
    {
        return $this->deleteInvoicesAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteInvoicesAsyncWithHttpInfo($id, string $contentType = self::contentTypes['deleteInvoices'][0])
    {
        $returnType = '';
        $request = $this->deleteInvoicesRequest($id, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deleteInvoicesRequest($id, string $contentType = self::contentTypes['deleteInvoices'][0])
    {
     ...
     * @param  string $id Invoice ID (required)
     * @param  string $source_id Source ID (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['detachSourceToInvoice'] to see the possible values for this operation
     *
     * @throws \DigitalRiver\ApiSdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function detachSourceToInvoice($id, $source_id, string $contentType = self::contentTypes['detachSourceToInvoice'][0])
    {
        $this->detachSourceToInvoiceWithHttpInfo($id, $source_id, $contentType);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function detachSourceToInvoiceWithHttpInfo($id, $source_id, string $contentType = self::contentTypes['detachSourceToInvoice'][0])
    {
        $request = $this->detachSourceToInvoiceRequest($id, $source_id, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function detachSourceToInvoiceAsync($id, $source_id, string $contentType = self::contentTypes['detachSourceToInvoice'][0])
    {
        return $this->detachSourceToInvoiceAsyncWithHttpInfo($id, $source_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function detachSourceToInvoiceAsyncWithHttpInfo($id, $source_id, string $contentType = self::contentTypes['detachSourceToInvoice'][0])
    {
        $returnType = '';
        $request = $this->detachSourceToInvoiceRequest($id, $source_id, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function detachSourceToInvoiceRequest($id, $source_id, string $contentType = self::contentTypes['detachSourceToInvoice'][0])
    {
     ...
     * @throws \DigitalRiver\ApiSdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \DigitalRiver\ApiSdk\Model\ListInvoices200Response|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors
     */
    public function listInvoices($created_time = null, $updated_time = null, $ending_before = null, $starting_after = null, $limit = null, $ids = null, $upstream_ids = null, $total_amount = null, $customer_id = null, $application_id = null, $currency = null, $state = null, $sku_id = null, $price = null, $attempt_count = null, string $contentType = self::contentTypes['listInvoices'][0])
    {
        list($response) = $this->listInvoicesWithHttpInfo($created_time, $updated_time, $ending_before, $starting_after, $limit, $ids, $upstream_ids, $total_amount, $customer_id, $application_id, $currency, $state, $sku_id, $price, $attempt_count, $contentType);
        return $response;
    }
     ...
     * @return array of \DigitalRiver\ApiSdk\Model\ListInvoices200Response|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors, HTTP status code, HTTP response headers (array of strings)
     */
    public function listInvoicesWithHttpInfo($created_time = null, $updated_time = null, $ending_before = null, $starting_after = null, $limit = null, $ids = null, $upstream_ids = null, $total_amount = null, $customer_id = null, $application_id = null, $currency = null, $state = null, $sku_id = null, $price = null, $attempt_count = null, string $contentType = self::contentTypes['listInvoices'][0])
    {
        $request = $this->listInvoicesRequest($created_time, $updated_time, $ending_before, $starting_after, $limit, $ids, $upstream_ids, $total_amount, $customer_id, $application_id, $currency, $state, $sku_id, $price, $attempt_count, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\DigitalRiver\ApiSdk\Model\ListInvoices200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\DigitalRiver\ApiSdk\Model\ListInvoices200Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\DigitalRiver\ApiSdk\Model\ListInvoices200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\DigitalRiver\ApiSdk\Model\ListInvoices200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\DigitalRiver\ApiSdk\Model\ListInvoices200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listInvoicesAsync($created_time = null, $updated_time = null, $ending_before = null, $starting_after = null, $limit = null, $ids = null, $upstream_ids = null, $total_amount = null, $customer_id = null, $application_id = null, $currency = null, $state = null, $sku_id = null, $price = null, $attempt_count = null, string $contentType = self::contentTypes['listInvoices'][0])
    {
        return $this->listInvoicesAsyncWithHttpInfo($created_time, $updated_time, $ending_before, $starting_after, $limit, $ids, $upstream_ids, $total_amount, $customer_id, $application_id, $currency, $state, $sku_id, $price, $attempt_count, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listInvoicesAsyncWithHttpInfo($created_time = null, $updated_time = null, $ending_before = null, $starting_after = null, $limit = null, $ids = null, $upstream_ids = null, $total_amount = null, $customer_id = null, $application_id = null, $currency = null, $state = null, $sku_id = null, $price = null, $attempt_count = null, string $contentType = self::contentTypes['listInvoices'][0])
    {
        $returnType = '\DigitalRiver\ApiSdk\Model\ListInvoices200Response';
        $request = $this->listInvoicesRequest($created_time, $updated_time, $ending_before, $starting_after, $limit, $ids, $upstream_ids, $total_amount, $customer_id, $application_id, $currency, $state, $sku_id, $price, $attempt_count, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function listInvoicesRequest($created_time = null, $updated_time = null, $ending_before = null, $starting_after = null, $limit = null, $ids = null, $upstream_ids = null, $total_amount = null, $customer_id = null, $application_id = null, $currency = null, $state = null, $sku_id = null, $price = null, $attempt_count = null, string $contentType = self::contentTypes['listInvoices'][0])
    {
     ...
     * @return \DigitalRiver\ApiSdk\Model\Invoice|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors
     */
    public function openInvoices($id, string $contentType = self::contentTypes['openInvoices'][0])
    {
        list($response) = $this->openInvoicesWithHttpInfo($id, $contentType);
        return $response;
    }
     ...
     * @return array of \DigitalRiver\ApiSdk\Model\Invoice|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors, HTTP status code, HTTP response headers (array of strings)
     */
    public function openInvoicesWithHttpInfo($id, string $contentType = self::contentTypes['openInvoices'][0])
    {
        $request = $this->openInvoicesRequest($id, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function openInvoicesAsync($id, string $contentType = self::contentTypes['openInvoices'][0])
    {
        return $this->openInvoicesAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function openInvoicesAsyncWithHttpInfo($id, string $contentType = self::contentTypes['openInvoices'][0])
    {
        $returnType = '\DigitalRiver\ApiSdk\Model\Invoice';
        $request = $this->openInvoicesRequest($id, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function openInvoicesRequest($id, string $contentType = self::contentTypes['openInvoices'][0])
    {
     ...
     *
     * @param  string $id The unique identifier of the Invoice. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['retrieveInvoices'] to see the possible values for this operation
     *
     * @throws \DigitalRiver\ApiSdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \DigitalRiver\ApiSdk\Model\Invoice|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors
     */
    public function retrieveInvoices($id, string $contentType = self::contentTypes['retrieveInvoices'][0])
    {
        list($response) = $this->retrieveInvoicesWithHttpInfo($id, $contentType);
        return $response;
    }
     ...
     * @return array of \DigitalRiver\ApiSdk\Model\Invoice|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors, HTTP status code, HTTP response headers (array of strings)
     */
    public function retrieveInvoicesWithHttpInfo($id, string $contentType = self::contentTypes['retrieveInvoices'][0])
    {
        $request = $this->retrieveInvoicesRequest($id, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveInvoicesAsync($id, string $contentType = self::contentTypes['retrieveInvoices'][0])
    {
        return $this->retrieveInvoicesAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveInvoicesAsyncWithHttpInfo($id, string $contentType = self::contentTypes['retrieveInvoices'][0])
    {
        $returnType = '\DigitalRiver\ApiSdk\Model\Invoice';
        $request = $this->retrieveInvoicesRequest($id, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function retrieveInvoicesRequest($id, string $contentType = self::contentTypes['retrieveInvoices'][0])
    {
     ...
     * @return \DigitalRiver\ApiSdk\Model\Invoice|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors
     */
    public function updateInvoices($id, $update_invoice_request = null, string $contentType = self::contentTypes['updateInvoices'][0])
    {
        list($response) = $this->updateInvoicesWithHttpInfo($id, $update_invoice_request, $contentType);
        return $response;
    }
     ...
     * @return array of \DigitalRiver\ApiSdk\Model\Invoice|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateInvoicesWithHttpInfo($id, $update_invoice_request = null, string $contentType = self::contentTypes['updateInvoices'][0])
    {
        $request = $this->updateInvoicesRequest($id, $update_invoice_request, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateInvoicesAsync($id, $update_invoice_request = null, string $contentType = self::contentTypes['updateInvoices'][0])
    {
        return $this->updateInvoicesAsyncWithHttpInfo($id, $update_invoice_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateInvoicesAsyncWithHttpInfo($id, $update_invoice_request = null, string $contentType = self::contentTypes['updateInvoices'][0])
    {
        $returnType = '\DigitalRiver\ApiSdk\Model\Invoice';
        $request = $this->updateInvoicesRequest($id, $update_invoice_request, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateInvoicesRequest($id, $update_invoice_request = null, string $contentType = self::contentTypes['updateInvoices'][0])
    {
     ...
     *
     * @param  string $id The unique identifier of the invoice. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['voidInvoices'] to see the possible values for this operation
     *
     * @throws \DigitalRiver\ApiSdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \DigitalRiver\ApiSdk\Model\Invoice|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors
     */
    public function voidInvoices($id, string $contentType = self::contentTypes['voidInvoices'][0])
    {
        list($response) = $this->voidInvoicesWithHttpInfo($id, $contentType);
        return $response;
    }
     ...
     * @return array of \DigitalRiver\ApiSdk\Model\Invoice|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors, HTTP status code, HTTP response headers (array of strings)
     */
    public function voidInvoicesWithHttpInfo($id, string $contentType = self::contentTypes['voidInvoices'][0])
    {
        $request = $this->voidInvoicesRequest($id, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function voidInvoicesAsync($id, string $contentType = self::contentTypes['voidInvoices'][0])
    {
        return $this->voidInvoicesAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function voidInvoicesAsyncWithHttpInfo($id, string $contentType = self::contentTypes['voidInvoices'][0])
    {
        $returnType = '\DigitalRiver\ApiSdk\Model\Invoice';
        $request = $this->voidInvoicesRequest($id, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function voidInvoicesRequest($id, string $contentType = self::contentTypes['voidInvoices'][0])
    {
