...
/**
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createReservations'] to see the possible values for this operation
     *
     ...
     */
    public function createReservations($reservation_request = null, string $contentType = self::contentTypes['createReservations'][0])
    {
        list($response) = $this->createReservationsWithHttpInfo($reservation_request, $contentType);
        return $response;
    }
     ...
     */
    public function createReservationsWithHttpInfo($reservation_request = null, string $contentType = self::contentTypes['createReservations'][0])
    {
        $request = $this->createReservationsRequest($reservation_request, $contentType);
            ...
            switch($statusCode) {
                case 201:
                    if ('\DigitalRiver\ApiSdk\Model\Reservation' === '\SplFileObject') {
                        ...
                        if ('\DigitalRiver\ApiSdk\Model\Reservation' !== 'string') {
     ...
     */
    public function createReservationsAsync($reservation_request = null, string $contentType = self::contentTypes['createReservations'][0])
    {
        return $this->createReservationsAsyncWithHttpInfo($reservation_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createReservationsAsyncWithHttpInfo($reservation_request = null, string $contentType = self::contentTypes['createReservations'][0])
    {
        $returnType = '\DigitalRiver\ApiSdk\Model\Reservation';
        $request = $this->createReservationsRequest($reservation_request, $contentType);
     ...
     */
    public function createReservationsRequest($reservation_request = null, string $contentType = self::contentTypes['createReservations'][0])
    {
        ...
        if (isset($reservation_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                ...
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($reservation_request));
            } else {
                $httpBody = $reservation_request;
            }
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['deleteReservations'] to see the possible values for this operation
     *
     * @throws \DigitalRiver\ApiSdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function deleteReservations($id, string $contentType = self::contentTypes['deleteReservations'][0])
    {
        $this->deleteReservationsWithHttpInfo($id, $contentType);
    }
     ...
     */
    public function deleteReservationsWithHttpInfo($id, string $contentType = self::contentTypes['deleteReservations'][0])
    {
        $request = $this->deleteReservationsRequest($id, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteReservationsAsync($id, string $contentType = self::contentTypes['deleteReservations'][0])
    {
        return $this->deleteReservationsAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteReservationsAsyncWithHttpInfo($id, string $contentType = self::contentTypes['deleteReservations'][0])
    {
        $returnType = '';
        $request = $this->deleteReservationsRequest($id, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deleteReservationsRequest($id, string $contentType = self::contentTypes['deleteReservations'][0])
    {
