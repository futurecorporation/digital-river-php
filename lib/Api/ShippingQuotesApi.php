...
/**
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postShippingQuotes'] to see the possible values for this operation
     *
     ...
     */
    public function postShippingQuotes($shipping_quote_request = null, string $contentType = self::contentTypes['postShippingQuotes'][0])
    {
        list($response) = $this->postShippingQuotesWithHttpInfo($shipping_quote_request, $contentType);
        return $response;
    }
     ...
     */
    public function postShippingQuotesWithHttpInfo($shipping_quote_request = null, string $contentType = self::contentTypes['postShippingQuotes'][0])
    {
        $request = $this->postShippingQuotesRequest($shipping_quote_request, $contentType);
            ...
            switch($statusCode) {
                case 200:
                    if ('\DigitalRiver\ApiSdk\Model\ShippingQuoteResponse' === '\SplFileObject') {
                        ...
                        if ('\DigitalRiver\ApiSdk\Model\ShippingQuoteResponse' !== 'string') {
     ...
     */
    public function postShippingQuotesAsync($shipping_quote_request = null, string $contentType = self::contentTypes['postShippingQuotes'][0])
    {
        return $this->postShippingQuotesAsyncWithHttpInfo($shipping_quote_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postShippingQuotesAsyncWithHttpInfo($shipping_quote_request = null, string $contentType = self::contentTypes['postShippingQuotes'][0])
    {
        $returnType = '\DigitalRiver\ApiSdk\Model\ShippingQuoteResponse';
        $request = $this->postShippingQuotesRequest($shipping_quote_request, $contentType);
     ...
     */
    public function postShippingQuotesRequest($shipping_quote_request = null, string $contentType = self::contentTypes['postShippingQuotes'][0])
    {
        ...
        if (isset($shipping_quote_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                ...
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($shipping_quote_request));
            } else {
