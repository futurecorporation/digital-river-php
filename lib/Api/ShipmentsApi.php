...
/**
     ...
     * @return \DigitalRiver\ApiSdk\Model\ListShipments200Response|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors
     */
    public function listShipments($created_time = null, $updated_time = null, $ending_before = null, $starting_after = null, $limit = null, $ids = null, string $contentType = self::contentTypes['listShipments'][0])
    {
        list($response) = $this->listShipmentsWithHttpInfo($created_time, $updated_time, $ending_before, $starting_after, $limit, $ids, $contentType);
        return $response;
    }
     ...
     */
    public function listShipmentsWithHttpInfo($created_time = null, $updated_time = null, $ending_before = null, $starting_after = null, $limit = null, $ids = null, string $contentType = self::contentTypes['listShipments'][0])
    {
        $request = $this->listShipmentsRequest($created_time, $updated_time, $ending_before, $starting_after, $limit, $ids, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\DigitalRiver\ApiSdk\Model\ListShipments200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\DigitalRiver\ApiSdk\Model\ListShipments200Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\DigitalRiver\ApiSdk\Model\ListShipments200Response', []),
            ...
            $returnType = '\DigitalRiver\ApiSdk\Model\ListShipments200Response';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\DigitalRiver\ApiSdk\Model\ListShipments200Response',
     ...
     */
    public function listShipmentsAsync($created_time = null, $updated_time = null, $ending_before = null, $starting_after = null, $limit = null, $ids = null, string $contentType = self::contentTypes['listShipments'][0])
    {
        return $this->listShipmentsAsyncWithHttpInfo($created_time, $updated_time, $ending_before, $starting_after, $limit, $ids, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listShipmentsAsyncWithHttpInfo($created_time = null, $updated_time = null, $ending_before = null, $starting_after = null, $limit = null, $ids = null, string $contentType = self::contentTypes['listShipments'][0])
    {
        $returnType = '\DigitalRiver\ApiSdk\Model\ListShipments200Response';
        $request = $this->listShipmentsRequest($created_time, $updated_time, $ending_before, $starting_after, $limit, $ids, $contentType);
     ...
     */
    public function listShipmentsRequest($created_time = null, $updated_time = null, $ending_before = null, $starting_after = null, $limit = null, $ids = null, string $contentType = self::contentTypes['listShipments'][0])
    {
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['retrieveShipments'] to see the possible values for this operation
     *
     * @throws \DigitalRiver\ApiSdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \DigitalRiver\ApiSdk\Model\Shipment|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors
     */
    public function retrieveShipments($id, string $contentType = self::contentTypes['retrieveShipments'][0])
    {
        list($response) = $this->retrieveShipmentsWithHttpInfo($id, $contentType);
        return $response;
    }
     ...
     * @return array of \DigitalRiver\ApiSdk\Model\Shipment|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors, HTTP status code, HTTP response headers (array of strings)
     */
    public function retrieveShipmentsWithHttpInfo($id, string $contentType = self::contentTypes['retrieveShipments'][0])
    {
        $request = $this->retrieveShipmentsRequest($id, $contentType);
            ...
            switch($statusCode) {
                case 200:
                    if ('\DigitalRiver\ApiSdk\Model\Shipment' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\DigitalRiver\ApiSdk\Model\Shipment' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveShipmentsAsync($id, string $contentType = self::contentTypes['retrieveShipments'][0])
    {
        return $this->retrieveShipmentsAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveShipmentsAsyncWithHttpInfo($id, string $contentType = self::contentTypes['retrieveShipments'][0])
    {
        $returnType = '\DigitalRiver\ApiSdk\Model\Shipment';
        $request = $this->retrieveShipmentsRequest($id, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function retrieveShipmentsRequest($id, string $contentType = self::contentTypes['retrieveShipments'][0])
    {
