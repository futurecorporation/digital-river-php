...
/**
    ...
    /**
     * Operation createFulfillmentOrders
     *
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createFulfillmentOrders'] to see the possible values for this operation
     *
     ...
     */
    public function createFulfillmentOrders($global_fulfillment_order_request = null, string $contentType = self::contentTypes['createFulfillmentOrders'][0])
    {
        list($response) = $this->createFulfillmentOrdersWithHttpInfo($global_fulfillment_order_request, $contentType);
        return $response;
    }

    /**
     * Operation createFulfillmentOrdersWithHttpInfo
     *
     * Creates a new Fulfillment order
     *
     ...
     */
    public function createFulfillmentOrdersWithHttpInfo($global_fulfillment_order_request = null, string $contentType = self::contentTypes['createFulfillmentOrders'][0])
    {
        $request = $this->createFulfillmentOrdersRequest($global_fulfillment_order_request, $contentType);
            ...
            switch($statusCode) {
                case 201:
                    if ('\DigitalRiver\ApiSdk\Model\GlobalFulfillmentOrder' === '\SplFileObject') {
                        ...
                        if ('\DigitalRiver\ApiSdk\Model\GlobalFulfillmentOrder' !== 'string') {
    ...
    /**
     * Operation createFulfillmentOrdersAsync
     *
     * Creates a new Fulfillment order
     *
     * @param  \DigitalRiver\ApiSdk\Model\GlobalFulfillmentOrderRequest $global_fulfillment_order_request (optional)
     ...
     */
    public function createFulfillmentOrdersAsync($global_fulfillment_order_request = null, string $contentType = self::contentTypes['createFulfillmentOrders'][0])
    {
        return $this->createFulfillmentOrdersAsyncWithHttpInfo($global_fulfillment_order_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation createFulfillmentOrdersAsyncWithHttpInfo
     *
     * Creates a new Fulfillment order
     *
     * @param  \DigitalRiver\ApiSdk\Model\GlobalFulfillmentOrderRequest $global_fulfillment_order_request (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createFulfillmentOrdersAsyncWithHttpInfo($global_fulfillment_order_request = null, string $contentType = self::contentTypes['createFulfillmentOrders'][0])
    {
        $returnType = '\DigitalRiver\ApiSdk\Model\GlobalFulfillmentOrder';
        $request = $this->createFulfillmentOrdersRequest($global_fulfillment_order_request, $contentType);
    ...
    /**
     * Create request for operation 'createFulfillmentOrders'
     *
     * @param  \DigitalRiver\ApiSdk\Model\GlobalFulfillmentOrderRequest $global_fulfillment_order_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createFulfillmentOrders'] to see the possible values for this operation
     *
     ...
     */
    public function createFulfillmentOrdersRequest($global_fulfillment_order_request = null, string $contentType = self::contentTypes['createFulfillmentOrders'][0])
    {
        ...
        if (isset($global_fulfillment_order_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                ...
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($global_fulfillment_order_request));
            } else {
                $httpBody = $global_fulfillment_order_request;
            }
    ...
    /**
     * Operation listFulfillmentOrders
     *
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['listFulfillmentOrders'] to see the possible values for this operation
     *
     * @throws \DigitalRiver\ApiSdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \DigitalRiver\ApiSdk\Model\ListFulfillmentOrders200Response|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors
     */
    public function listFulfillmentOrders($created_time = null, $updated_time = null, $ending_before = null, $starting_after = null, $limit = null, $ids = null, $upstream_ids = null, string $contentType = self::contentTypes['listFulfillmentOrders'][0])
    {
        list($response) = $this->listFulfillmentOrdersWithHttpInfo($created_time, $updated_time, $ending_before, $starting_after, $limit, $ids, $upstream_ids, $contentType);
        return $response;
    }

    /**
     * Operation listFulfillmentOrdersWithHttpInfo
     *
     * Returns a list of Fulfillment orders.
     *
     * @param  array<string,\DateTime> $created_time A filter on the list based on the **createdTime** field. The value can be a string with an ISO-8601 UTC format datetime or it can be a dictionary with the following options:    - **eq**&amp;mdash;return values where the createdTime field equals to this timestamp   - **gt**&amp;mdash;return values where the createdTime field is after this timestamp   - **gte**&amp;mdash;return values where the createdTime field is after or equal to this timestamp   - **lt**&amp;mdash;return values where the createdTime field is before this timestamp   - **lte**&amp;mdash;return values where the createdTime field is before or equal to this timestamp (optional)
     ...
     * @return array of \DigitalRiver\ApiSdk\Model\ListFulfillmentOrders200Response|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors, HTTP status code, HTTP response headers (array of strings)
     */
    public function listFulfillmentOrdersWithHttpInfo($created_time = null, $updated_time = null, $ending_before = null, $starting_after = null, $limit = null, $ids = null, $upstream_ids = null, string $contentType = self::contentTypes['listFulfillmentOrders'][0])
    {
        $request = $this->listFulfillmentOrdersRequest($created_time, $updated_time, $ending_before, $starting_after, $limit, $ids, $upstream_ids, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\DigitalRiver\ApiSdk\Model\ListFulfillmentOrders200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\DigitalRiver\ApiSdk\Model\ListFulfillmentOrders200Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\DigitalRiver\ApiSdk\Model\ListFulfillmentOrders200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\DigitalRiver\ApiSdk\Model\ListFulfillmentOrders200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\DigitalRiver\ApiSdk\Model\ListFulfillmentOrders200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation listFulfillmentOrdersAsync
     *
     * Returns a list of Fulfillment orders.
     *
     * @param  array<string,\DateTime> $created_time A filter on the list based on the **createdTime** field. The value can be a string with an ISO-8601 UTC format datetime or it can be a dictionary with the following options:    - **eq**&amp;mdash;return values where the createdTime field equals to this timestamp   - **gt**&amp;mdash;return values where the createdTime field is after this timestamp   - **gte**&amp;mdash;return values where the createdTime field is after or equal to this timestamp   - **lt**&amp;mdash;return values where the createdTime field is before this timestamp   - **lte**&amp;mdash;return values where the createdTime field is before or equal to this timestamp (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listFulfillmentOrdersAsync($created_time = null, $updated_time = null, $ending_before = null, $starting_after = null, $limit = null, $ids = null, $upstream_ids = null, string $contentType = self::contentTypes['listFulfillmentOrders'][0])
    {
        return $this->listFulfillmentOrdersAsyncWithHttpInfo($created_time, $updated_time, $ending_before, $starting_after, $limit, $ids, $upstream_ids, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation listFulfillmentOrdersAsyncWithHttpInfo
     *
     * Returns a list of Fulfillment orders.
     *
     * @param  array<string,\DateTime> $created_time A filter on the list based on the **createdTime** field. The value can be a string with an ISO-8601 UTC format datetime or it can be a dictionary with the following options:    - **eq**&amp;mdash;return values where the createdTime field equals to this timestamp   - **gt**&amp;mdash;return values where the createdTime field is after this timestamp   - **gte**&amp;mdash;return values where the createdTime field is after or equal to this timestamp   - **lt**&amp;mdash;return values where the createdTime field is before this timestamp   - **lte**&amp;mdash;return values where the createdTime field is before or equal to this timestamp (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listFulfillmentOrdersAsyncWithHttpInfo($created_time = null, $updated_time = null, $ending_before = null, $starting_after = null, $limit = null, $ids = null, $upstream_ids = null, string $contentType = self::contentTypes['listFulfillmentOrders'][0])
    {
        $returnType = '\DigitalRiver\ApiSdk\Model\ListFulfillmentOrders200Response';
        $request = $this->listFulfillmentOrdersRequest($created_time, $updated_time, $ending_before, $starting_after, $limit, $ids, $upstream_ids, $contentType);
    ...
    /**
     * Create request for operation 'listFulfillmentOrders'
     *
     * @param  array<string,\DateTime> $created_time A filter on the list based on the **createdTime** field. The value can be a string with an ISO-8601 UTC format datetime or it can be a dictionary with the following options:    - **eq**&amp;mdash;return values where the createdTime field equals to this timestamp   - **gt**&amp;mdash;return values where the createdTime field is after this timestamp   - **gte**&amp;mdash;return values where the createdTime field is after or equal to this timestamp   - **lt**&amp;mdash;return values where the createdTime field is before this timestamp   - **lte**&amp;mdash;return values where the createdTime field is before or equal to this timestamp (optional)
     * @param  array<string,\DateTime> $updated_time A filter on the list based on the **updatedTime** field. The value can be a string with an ISO-8601 UTC format datetime or it can be a dictionary with the following options:    - **eq**&amp;mdash;return values where the updatedTime field equals this timestamp   - **gt**&amp;mdash;return values where the updatedTime field is after this timestamp   - **gte**&amp;mdash;return values where the updatedTime field is after or equal to this timestamp   - **lt**&amp;mdash;return values where the updatedTime field is before this timestamp   - **lte**&amp;mdash;return values where the updatedTime field is before or equal to this timestamp (optional)
     * @param  string $ending_before A cursor for use in pagination. The endingBefore parameter is an object ID that defines your place in the list. For instance, if you make a list request and receive 100 objects, starting with xyz your subsequent calls can include endingBefore&#x3D;xyz in order to fetch the previous page of the list. (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function listFulfillmentOrdersRequest($created_time = null, $updated_time = null, $ending_before = null, $starting_after = null, $limit = null, $ids = null, $upstream_ids = null, string $contentType = self::contentTypes['listFulfillmentOrders'][0])
    {
        ...
        if ($limit !== null && $limit > 100) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling FulfillmentOrdersApi.listFulfillmentOrders, must be smaller than or equal to 100.');
        }
        if ($limit !== null && $limit < 1) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling FulfillmentOrdersApi.listFulfillmentOrders, must be bigger than or equal to 1.');
        }
    ...
    /**
     * Operation retrieveFulfillmentOrders
     *
     * Gets a Fulfillment order by ID.
     *
     * @param  string $id Fulfillment order identifier. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['retrieveFulfillmentOrders'] to see the possible values for this operation
     *
     * @throws \DigitalRiver\ApiSdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \DigitalRiver\ApiSdk\Model\GlobalFulfillmentOrder|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors
     */
    public function retrieveFulfillmentOrders($id, string $contentType = self::contentTypes['retrieveFulfillmentOrders'][0])
    {
        list($response) = $this->retrieveFulfillmentOrdersWithHttpInfo($id, $contentType);
        return $response;
    }

    /**
     * Operation retrieveFulfillmentOrdersWithHttpInfo
     *
     * Gets a Fulfillment order by ID.
     *
     * @param  string $id Fulfillment order identifier. (required)
     ...
     * @return array of \DigitalRiver\ApiSdk\Model\GlobalFulfillmentOrder|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors, HTTP status code, HTTP response headers (array of strings)
     */
    public function retrieveFulfillmentOrdersWithHttpInfo($id, string $contentType = self::contentTypes['retrieveFulfillmentOrders'][0])
    {
        $request = $this->retrieveFulfillmentOrdersRequest($id, $contentType);
    ...
    /**
     * Operation retrieveFulfillmentOrdersAsync
     *
     * Gets a Fulfillment order by ID.
     *
     * @param  string $id Fulfillment order identifier. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveFulfillmentOrdersAsync($id, string $contentType = self::contentTypes['retrieveFulfillmentOrders'][0])
    {
        return $this->retrieveFulfillmentOrdersAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation retrieveFulfillmentOrdersAsyncWithHttpInfo
     *
     * Gets a Fulfillment order by ID.
     *
     * @param  string $id Fulfillment order identifier. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveFulfillmentOrdersAsyncWithHttpInfo($id, string $contentType = self::contentTypes['retrieveFulfillmentOrders'][0])
    {
        $returnType = '\DigitalRiver\ApiSdk\Model\GlobalFulfillmentOrder';
        $request = $this->retrieveFulfillmentOrdersRequest($id, $contentType);
    ...
    /**
     * Create request for operation 'retrieveFulfillmentOrders'
     *
     * @param  string $id Fulfillment order identifier. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['retrieveFulfillmentOrders'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function retrieveFulfillmentOrdersRequest($id, string $contentType = self::contentTypes['retrieveFulfillmentOrders'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling retrieveFulfillmentOrders'
            );
        }
