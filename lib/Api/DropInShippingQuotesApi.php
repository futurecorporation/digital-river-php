...
/**
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['listShippingMethodQuotes'] to see the possible values for this operation
     *
     ...
     */
    public function listShippingMethodQuotes($shipping_method_quote_request = null, string $contentType = self::contentTypes['listShippingMethodQuotes'][0])
    {
        list($response) = $this->listShippingMethodQuotesWithHttpInfo($shipping_method_quote_request, $contentType);
        return $response;
    }
     ...
     */
    public function listShippingMethodQuotesWithHttpInfo($shipping_method_quote_request = null, string $contentType = self::contentTypes['listShippingMethodQuotes'][0])
    {
        $request = $this->listShippingMethodQuotesRequest($shipping_method_quote_request, $contentType);
            ...
            switch($statusCode) {
                case 200:
                    if ('\DigitalRiver\ApiSdk\Model\ShippingMethodQuoteResponse' === '\SplFileObject') {
                        ...
                        if ('\DigitalRiver\ApiSdk\Model\ShippingMethodQuoteResponse' !== 'string') {
     ...
     */
    public function listShippingMethodQuotesAsync($shipping_method_quote_request = null, string $contentType = self::contentTypes['listShippingMethodQuotes'][0])
    {
        return $this->listShippingMethodQuotesAsyncWithHttpInfo($shipping_method_quote_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listShippingMethodQuotesAsyncWithHttpInfo($shipping_method_quote_request = null, string $contentType = self::contentTypes['listShippingMethodQuotes'][0])
    {
        $returnType = '\DigitalRiver\ApiSdk\Model\ShippingMethodQuoteResponse';
        $request = $this->listShippingMethodQuotesRequest($shipping_method_quote_request, $contentType);
     ...
     */
    public function listShippingMethodQuotesRequest($shipping_method_quote_request = null, string $contentType = self::contentTypes['listShippingMethodQuotes'][0])
    {
        ...
        if (isset($shipping_method_quote_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                ...
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($shipping_method_quote_request));
            } else {
                $httpBody = $shipping_method_quote_request;
            }
