...
/**
    ...
    /**
     * Operation retrieveCharges
     *
     * Gets a charge by ID
     *
     * @param  string $id Charge ID (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['retrieveCharges'] to see the possible values for this operation
     *
     * @throws \DigitalRiver\ApiSdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \DigitalRiver\ApiSdk\Model\Charge|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors
     */
    public function retrieveCharges($id, string $contentType = self::contentTypes['retrieveCharges'][0])
    {
        list($response) = $this->retrieveChargesWithHttpInfo($id, $contentType);
        return $response;
    }

    /**
     * Operation retrieveChargesWithHttpInfo
     *
     * Gets a charge by ID
     *
     * @param  string $id Charge ID (required)
     ...
     */
    public function retrieveChargesWithHttpInfo($id, string $contentType = self::contentTypes['retrieveCharges'][0])
    {
        $request = $this->retrieveChargesRequest($id, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\DigitalRiver\ApiSdk\Model\Charge' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\DigitalRiver\ApiSdk\Model\Charge' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\DigitalRiver\ApiSdk\Model\Charge', []),
            ...
            $returnType = '\DigitalRiver\ApiSdk\Model\Charge';
    ...
    /**
     * Operation retrieveChargesAsync
     *
     * Gets a charge by ID
     *
     * @param  string $id Charge ID (required)
     ...
     */
    public function retrieveChargesAsync($id, string $contentType = self::contentTypes['retrieveCharges'][0])
    {
        return $this->retrieveChargesAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation retrieveChargesAsyncWithHttpInfo
     *
     * Gets a charge by ID
     *
     * @param  string $id Charge ID (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveChargesAsyncWithHttpInfo($id, string $contentType = self::contentTypes['retrieveCharges'][0])
    {
        $returnType = '\DigitalRiver\ApiSdk\Model\Charge';
        $request = $this->retrieveChargesRequest($id, $contentType);
    ...
    /**
     * Create request for operation 'retrieveCharges'
     *
     * @param  string $id Charge ID (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['retrieveCharges'] to see the possible values for this operation
     *
     ...
     */
    public function retrieveChargesRequest($id, string $contentType = self::contentTypes['retrieveCharges'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling retrieveCharges'
            );
        }
