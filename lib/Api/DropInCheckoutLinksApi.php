...
/**
 * DropInCheckoutLinksApi Class Doc Comment
 *
 * @category Class
 * @package  DigitalRiver\ApiSdk
 * @author   OpenAPI Generator team
...
/**
    ...
    /**
     * Operation createDropInCheckoutLink
     *
     * Creates a new Drop-in checkout link
     *
     * @param  \DigitalRiver\ApiSdk\Model\DropInCheckoutLink $drop_in_checkout_link drop_in_checkout_link (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createDropInCheckoutLink'] to see the possible values for this operation
     *
     ...
     */
    public function createDropInCheckoutLink($drop_in_checkout_link = null, string $contentType = self::contentTypes['createDropInCheckoutLink'][0])
    {
        list($response) = $this->createDropInCheckoutLinkWithHttpInfo($drop_in_checkout_link, $contentType);
        return $response;
    }

    /**
     * Operation createDropInCheckoutLinkWithHttpInfo
     *
     * Creates a new Drop-in checkout link
     *
     * @param  \DigitalRiver\ApiSdk\Model\DropInCheckoutLink $drop_in_checkout_link (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createDropInCheckoutLink'] to see the possible values for this operation
     *
     * @throws \DigitalRiver\ApiSdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     */
    public function createDropInCheckoutLinkWithHttpInfo($drop_in_checkout_link = null, string $contentType = self::contentTypes['createDropInCheckoutLink'][0])
    {
        $request = $this->createDropInCheckoutLinkRequest($drop_in_checkout_link, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\DigitalRiver\ApiSdk\Model\DropInCheckoutLinkResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\DigitalRiver\ApiSdk\Model\DropInCheckoutLinkResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\DigitalRiver\ApiSdk\Model\DropInCheckoutLinkResponse', []),
            ...
            $returnType = '\DigitalRiver\ApiSdk\Model\DropInCheckoutLinkResponse';
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\DigitalRiver\ApiSdk\Model\DropInCheckoutLinkResponse',
    ...
    /**
     * Operation createDropInCheckoutLinkAsync
     *
     * Creates a new Drop-in checkout link
     *
     * @param  \DigitalRiver\ApiSdk\Model\DropInCheckoutLink $drop_in_checkout_link (optional)
     ...
     */
    public function createDropInCheckoutLinkAsync($drop_in_checkout_link = null, string $contentType = self::contentTypes['createDropInCheckoutLink'][0])
    {
        return $this->createDropInCheckoutLinkAsyncWithHttpInfo($drop_in_checkout_link, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation createDropInCheckoutLinkAsyncWithHttpInfo
     *
     * Creates a new Drop-in checkout link
     *
     * @param  \DigitalRiver\ApiSdk\Model\DropInCheckoutLink $drop_in_checkout_link (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createDropInCheckoutLinkAsyncWithHttpInfo($drop_in_checkout_link = null, string $contentType = self::contentTypes['createDropInCheckoutLink'][0])
    {
        $returnType = '\DigitalRiver\ApiSdk\Model\DropInCheckoutLinkResponse';
        $request = $this->createDropInCheckoutLinkRequest($drop_in_checkout_link, $contentType);
    ...
    /**
     * Create request for operation 'createDropInCheckoutLink'
     *
     * @param  \DigitalRiver\ApiSdk\Model\DropInCheckoutLink $drop_in_checkout_link (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createDropInCheckoutLink'] to see the possible values for this operation
     *
     ...
     */
    public function createDropInCheckoutLinkRequest($drop_in_checkout_link = null, string $contentType = self::contentTypes['createDropInCheckoutLink'][0])
    {



        $resourcePath = '/drop-in/checkout-links';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($drop_in_checkout_link)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($drop_in_checkout_link));
            } else {
                $httpBody = $drop_in_checkout_link;
            }
    ...
    /**
     * Operation deleteDropInCheckoutLinks
     *
     * Deletes a Drop-in checkout link by ID.
     *
     * @param  string $id Link ID (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['deleteDropInCheckoutLinks'] to see the possible values for this operation
     *
     * @throws \DigitalRiver\ApiSdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function deleteDropInCheckoutLinks($id, string $contentType = self::contentTypes['deleteDropInCheckoutLinks'][0])
    {
        $this->deleteDropInCheckoutLinksWithHttpInfo($id, $contentType);
    }

    /**
     * Operation deleteDropInCheckoutLinksWithHttpInfo
     *
     * Deletes a Drop-in checkout link by ID.
     *
     * @param  string $id Link ID (required)
     ...
     */
    public function deleteDropInCheckoutLinksWithHttpInfo($id, string $contentType = self::contentTypes['deleteDropInCheckoutLinks'][0])
    {
        $request = $this->deleteDropInCheckoutLinksRequest($id, $contentType);
    ...
    /**
     * Operation deleteDropInCheckoutLinksAsync
     *
     * Deletes a Drop-in checkout link by ID.
     *
     * @param  string $id Link ID (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteDropInCheckoutLinksAsync($id, string $contentType = self::contentTypes['deleteDropInCheckoutLinks'][0])
    {
        return $this->deleteDropInCheckoutLinksAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation deleteDropInCheckoutLinksAsyncWithHttpInfo
     *
     * Deletes a Drop-in checkout link by ID.
     *
     * @param  string $id Link ID (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteDropInCheckoutLinksAsyncWithHttpInfo($id, string $contentType = self::contentTypes['deleteDropInCheckoutLinks'][0])
    {
        $returnType = '';
        $request = $this->deleteDropInCheckoutLinksRequest($id, $contentType);
    ...
    /**
     * Create request for operation 'deleteDropInCheckoutLinks'
     *
     * @param  string $id Link ID (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['deleteDropInCheckoutLinks'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deleteDropInCheckoutLinksRequest($id, string $contentType = self::contentTypes['deleteDropInCheckoutLinks'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling deleteDropInCheckoutLinks'
            );
        }


        $resourcePath = '/drop-in/checkout-links/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation listDropInCheckoutLink
     *
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['listDropInCheckoutLink'] to see the possible values for this operation
     *
     * @throws \DigitalRiver\ApiSdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \DigitalRiver\ApiSdk\Model\ListCheckoutLinksResponse|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors
     */
    public function listDropInCheckoutLink($created_time = null, $ending_before = null, $starting_after = null, $limit = null, $ids = null, string $contentType = self::contentTypes['listDropInCheckoutLink'][0])
    {
        list($response) = $this->listDropInCheckoutLinkWithHttpInfo($created_time, $ending_before, $starting_after, $limit, $ids, $contentType);
        return $response;
    }

    /**
     * Operation listDropInCheckoutLinkWithHttpInfo
     *
     * List Drop-in checkout links
     *
     * @param  array<string,\DateTime> $created_time A filter on the list based on the **createdTime** field. The value can be a string with an ISO-8601 UTC format datetime or it can be a dictionary with the following options:    - **eq**&amp;mdash;return values where the createdTime field equals to this timestamp   - **gt**&amp;mdash;return values where the createdTime field is after this timestamp   - **gte**&amp;mdash;return values where the createdTime field is after or equal to this timestamp   - **lt**&amp;mdash;return values where the createdTime field is before this timestamp   - **lte**&amp;mdash;return values where the createdTime field is before or equal to this timestamp (optional)
     ...
     * @return array of \DigitalRiver\ApiSdk\Model\ListCheckoutLinksResponse|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors, HTTP status code, HTTP response headers (array of strings)
     */
    public function listDropInCheckoutLinkWithHttpInfo($created_time = null, $ending_before = null, $starting_after = null, $limit = null, $ids = null, string $contentType = self::contentTypes['listDropInCheckoutLink'][0])
    {
        $request = $this->listDropInCheckoutLinkRequest($created_time, $ending_before, $starting_after, $limit, $ids, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\DigitalRiver\ApiSdk\Model\ListCheckoutLinksResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\DigitalRiver\ApiSdk\Model\ListCheckoutLinksResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\DigitalRiver\ApiSdk\Model\ListCheckoutLinksResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\DigitalRiver\ApiSdk\Model\ListCheckoutLinksResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\DigitalRiver\ApiSdk\Model\ListCheckoutLinksResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation listDropInCheckoutLinkAsync
     *
     * List Drop-in checkout links
     *
     * @param  array<string,\DateTime> $created_time A filter on the list based on the **createdTime** field. The value can be a string with an ISO-8601 UTC format datetime or it can be a dictionary with the following options:    - **eq**&amp;mdash;return values where the createdTime field equals to this timestamp   - **gt**&amp;mdash;return values where the createdTime field is after this timestamp   - **gte**&amp;mdash;return values where the createdTime field is after or equal to this timestamp   - **lt**&amp;mdash;return values where the createdTime field is before this timestamp   - **lte**&amp;mdash;return values where the createdTime field is before or equal to this timestamp (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listDropInCheckoutLinkAsync($created_time = null, $ending_before = null, $starting_after = null, $limit = null, $ids = null, string $contentType = self::contentTypes['listDropInCheckoutLink'][0])
    {
        return $this->listDropInCheckoutLinkAsyncWithHttpInfo($created_time, $ending_before, $starting_after, $limit, $ids, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation listDropInCheckoutLinkAsyncWithHttpInfo
     *
     * List Drop-in checkout links
     *
     * @param  array<string,\DateTime> $created_time A filter on the list based on the **createdTime** field. The value can be a string with an ISO-8601 UTC format datetime or it can be a dictionary with the following options:    - **eq**&amp;mdash;return values where the createdTime field equals to this timestamp   - **gt**&amp;mdash;return values where the createdTime field is after this timestamp   - **gte**&amp;mdash;return values where the createdTime field is after or equal to this timestamp   - **lt**&amp;mdash;return values where the createdTime field is before this timestamp   - **lte**&amp;mdash;return values where the createdTime field is before or equal to this timestamp (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listDropInCheckoutLinkAsyncWithHttpInfo($created_time = null, $ending_before = null, $starting_after = null, $limit = null, $ids = null, string $contentType = self::contentTypes['listDropInCheckoutLink'][0])
    {
        $returnType = '\DigitalRiver\ApiSdk\Model\ListCheckoutLinksResponse';
        $request = $this->listDropInCheckoutLinkRequest($created_time, $ending_before, $starting_after, $limit, $ids, $contentType);
    ...
    /**
     * Create request for operation 'listDropInCheckoutLink'
     *
     * @param  array<string,\DateTime> $created_time A filter on the list based on the **createdTime** field. The value can be a string with an ISO-8601 UTC format datetime or it can be a dictionary with the following options:    - **eq**&amp;mdash;return values where the createdTime field equals to this timestamp   - **gt**&amp;mdash;return values where the createdTime field is after this timestamp   - **gte**&amp;mdash;return values where the createdTime field is after or equal to this timestamp   - **lt**&amp;mdash;return values where the createdTime field is before this timestamp   - **lte**&amp;mdash;return values where the createdTime field is before or equal to this timestamp (optional)
     * @param  string $ending_before A cursor for use in pagination. The endingBefore parameter is an object ID that defines your place in the list. For instance, if you make a list request and receive 100 objects, starting with xyz your subsequent calls can include endingBefore&#x3D;xyz in order to fetch the previous page of the list. (optional)
     * @param  string $starting_after A cursor for use in pagination. The startingAfter parameter is an object ID that defines your place in the list. For instance, if you make a list request and receive 100 objects, ending with xyz, your subsequent calls can include startingAfter&#x3D;xyz in order to fetch the next page of the list. (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function listDropInCheckoutLinkRequest($created_time = null, $ending_before = null, $starting_after = null, $limit = null, $ids = null, string $contentType = self::contentTypes['listDropInCheckoutLink'][0])
    {
        ...
        if ($limit !== null && $limit > 100) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling DropInCheckoutLinksApi.listDropInCheckoutLink, must be smaller than or equal to 100.');
        }
        if ($limit !== null && $limit < 1) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling DropInCheckoutLinksApi.listDropInCheckoutLink, must be bigger than or equal to 1.');
        }
