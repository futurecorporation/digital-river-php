...
/**
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createFulfillmentCancellations'] to see the possible values for this operation
     *
     ...
     */
    public function createFulfillmentCancellations($global_fulfillment_cancellation_request = null, string $contentType = self::contentTypes['createFulfillmentCancellations'][0])
    {
        list($response) = $this->createFulfillmentCancellationsWithHttpInfo($global_fulfillment_cancellation_request, $contentType);
        return $response;
    }
     ...
     */
    public function createFulfillmentCancellationsWithHttpInfo($global_fulfillment_cancellation_request = null, string $contentType = self::contentTypes['createFulfillmentCancellations'][0])
    {
        $request = $this->createFulfillmentCancellationsRequest($global_fulfillment_cancellation_request, $contentType);
            ...
            switch($statusCode) {
                case 201:
                    if ('\DigitalRiver\ApiSdk\Model\GlobalFulfillmentCancellationResponse' === '\SplFileObject') {
                        ...
                        if ('\DigitalRiver\ApiSdk\Model\GlobalFulfillmentCancellationResponse' !== 'string') {
     ...
     */
    public function createFulfillmentCancellationsAsync($global_fulfillment_cancellation_request = null, string $contentType = self::contentTypes['createFulfillmentCancellations'][0])
    {
        return $this->createFulfillmentCancellationsAsyncWithHttpInfo($global_fulfillment_cancellation_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createFulfillmentCancellationsAsyncWithHttpInfo($global_fulfillment_cancellation_request = null, string $contentType = self::contentTypes['createFulfillmentCancellations'][0])
    {
        $returnType = '\DigitalRiver\ApiSdk\Model\GlobalFulfillmentCancellationResponse';
        $request = $this->createFulfillmentCancellationsRequest($global_fulfillment_cancellation_request, $contentType);
     ...
     */
    public function createFulfillmentCancellationsRequest($global_fulfillment_cancellation_request = null, string $contentType = self::contentTypes['createFulfillmentCancellations'][0])
    {
        ...
        if (isset($global_fulfillment_cancellation_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                ...
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($global_fulfillment_cancellation_request));
            } else {
                $httpBody = $global_fulfillment_cancellation_request;
            }
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['listFulfillmentCancellations'] to see the possible values for this operation
     *
     * @throws \DigitalRiver\ApiSdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \DigitalRiver\ApiSdk\Model\ListGlobalFulfillmentCancellationsResponse|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors
     */
    public function listFulfillmentCancellations($created_time = null, $ending_before = null, $starting_after = null, $limit = null, $ids = null, $upstream_ids = null, $state = null, $fulfillment_order_id = null, $inventory_item_id = null, string $contentType = self::contentTypes['listFulfillmentCancellations'][0])
    {
        list($response) = $this->listFulfillmentCancellationsWithHttpInfo($created_time, $ending_before, $starting_after, $limit, $ids, $upstream_ids, $state, $fulfillment_order_id, $inventory_item_id, $contentType);
        return $response;
    }
     ...
     * @return array of \DigitalRiver\ApiSdk\Model\ListGlobalFulfillmentCancellationsResponse|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors, HTTP status code, HTTP response headers (array of strings)
     */
    public function listFulfillmentCancellationsWithHttpInfo($created_time = null, $ending_before = null, $starting_after = null, $limit = null, $ids = null, $upstream_ids = null, $state = null, $fulfillment_order_id = null, $inventory_item_id = null, string $contentType = self::contentTypes['listFulfillmentCancellations'][0])
    {
        $request = $this->listFulfillmentCancellationsRequest($created_time, $ending_before, $starting_after, $limit, $ids, $upstream_ids, $state, $fulfillment_order_id, $inventory_item_id, $contentType);
            ...
            switch($statusCode) {
                case 200:
                    if ('\DigitalRiver\ApiSdk\Model\ListGlobalFulfillmentCancellationsResponse' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\DigitalRiver\ApiSdk\Model\ListGlobalFulfillmentCancellationsResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listFulfillmentCancellationsAsync($created_time = null, $ending_before = null, $starting_after = null, $limit = null, $ids = null, $upstream_ids = null, $state = null, $fulfillment_order_id = null, $inventory_item_id = null, string $contentType = self::contentTypes['listFulfillmentCancellations'][0])
    {
        return $this->listFulfillmentCancellationsAsyncWithHttpInfo($created_time, $ending_before, $starting_after, $limit, $ids, $upstream_ids, $state, $fulfillment_order_id, $inventory_item_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listFulfillmentCancellationsAsyncWithHttpInfo($created_time = null, $ending_before = null, $starting_after = null, $limit = null, $ids = null, $upstream_ids = null, $state = null, $fulfillment_order_id = null, $inventory_item_id = null, string $contentType = self::contentTypes['listFulfillmentCancellations'][0])
    {
        $returnType = '\DigitalRiver\ApiSdk\Model\ListGlobalFulfillmentCancellationsResponse';
        $request = $this->listFulfillmentCancellationsRequest($created_time, $ending_before, $starting_after, $limit, $ids, $upstream_ids, $state, $fulfillment_order_id, $inventory_item_id, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function listFulfillmentCancellationsRequest($created_time = null, $ending_before = null, $starting_after = null, $limit = null, $ids = null, $upstream_ids = null, $state = null, $fulfillment_order_id = null, $inventory_item_id = null, string $contentType = self::contentTypes['listFulfillmentCancellations'][0])
    {
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['retrieveFulfillmentCancellations'] to see the possible values for this operation
     *
     * @throws \DigitalRiver\ApiSdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \DigitalRiver\ApiSdk\Model\GlobalFulfillmentCancellationResponse|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors
     */
    public function retrieveFulfillmentCancellations($id, string $contentType = self::contentTypes['retrieveFulfillmentCancellations'][0])
    {
        list($response) = $this->retrieveFulfillmentCancellationsWithHttpInfo($id, $contentType);
        return $response;
    }
     ...
     * @return array of \DigitalRiver\ApiSdk\Model\GlobalFulfillmentCancellationResponse|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors, HTTP status code, HTTP response headers (array of strings)
     */
    public function retrieveFulfillmentCancellationsWithHttpInfo($id, string $contentType = self::contentTypes['retrieveFulfillmentCancellations'][0])
    {
        $request = $this->retrieveFulfillmentCancellationsRequest($id, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveFulfillmentCancellationsAsync($id, string $contentType = self::contentTypes['retrieveFulfillmentCancellations'][0])
    {
        return $this->retrieveFulfillmentCancellationsAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveFulfillmentCancellationsAsyncWithHttpInfo($id, string $contentType = self::contentTypes['retrieveFulfillmentCancellations'][0])
    {
        $returnType = '\DigitalRiver\ApiSdk\Model\GlobalFulfillmentCancellationResponse';
        $request = $this->retrieveFulfillmentCancellationsRequest($id, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function retrieveFulfillmentCancellationsRequest($id, string $contentType = self::contentTypes['retrieveFulfillmentCancellations'][0])
    {
