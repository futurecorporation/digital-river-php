...
/**
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['listSkuGroups'] to see the possible values for this operation
     *
     ...
     */
    public function listSkuGroups($ending_before = null, $starting_after = null, $limit = null, $ids = null, string $contentType = self::contentTypes['listSkuGroups'][0])
    {
        list($response) = $this->listSkuGroupsWithHttpInfo($ending_before, $starting_after, $limit, $ids, $contentType);
        return $response;
    }
     ...
     */
    public function listSkuGroupsWithHttpInfo($ending_before = null, $starting_after = null, $limit = null, $ids = null, string $contentType = self::contentTypes['listSkuGroups'][0])
    {
        $request = $this->listSkuGroupsRequest($ending_before, $starting_after, $limit, $ids, $contentType);
            ...
            switch($statusCode) {
                case 200:
                    if ('\DigitalRiver\ApiSdk\Model\ListSkuGroupsResponse' === '\SplFileObject') {
                        ...
                        if ('\DigitalRiver\ApiSdk\Model\ListSkuGroupsResponse' !== 'string') {
     ...
     */
    public function listSkuGroupsAsync($ending_before = null, $starting_after = null, $limit = null, $ids = null, string $contentType = self::contentTypes['listSkuGroups'][0])
    {
        return $this->listSkuGroupsAsyncWithHttpInfo($ending_before, $starting_after, $limit, $ids, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listSkuGroupsAsyncWithHttpInfo($ending_before = null, $starting_after = null, $limit = null, $ids = null, string $contentType = self::contentTypes['listSkuGroups'][0])
    {
        $returnType = '\DigitalRiver\ApiSdk\Model\ListSkuGroupsResponse';
        $request = $this->listSkuGroupsRequest($ending_before, $starting_after, $limit, $ids, $contentType);
     ...
     */
    public function listSkuGroupsRequest($ending_before = null, $starting_after = null, $limit = null, $ids = null, string $contentType = self::contentTypes['listSkuGroups'][0])
    {
