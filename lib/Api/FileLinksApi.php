...
/**
 * FileLinksApi Class Doc Comment
 *
 * @category Class
 * @package  DigitalRiver\ApiSdk
 * @author   OpenAPI Generator team
...
/**
    ...
    /**
     * Operation createFileLinks
     *
     * Creates a file link
     *
     * @param  \DigitalRiver\ApiSdk\Model\FileLinkRequest $file_link_request file_link_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createFileLinks'] to see the possible values for this operation
     *
     * @throws \DigitalRiver\ApiSdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \DigitalRiver\ApiSdk\Model\FileLink|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors
     */
    public function createFileLinks($file_link_request = null, string $contentType = self::contentTypes['createFileLinks'][0])
    {
        list($response) = $this->createFileLinksWithHttpInfo($file_link_request, $contentType);
        return $response;
    }

    /**
     * Operation createFileLinksWithHttpInfo
     *
     * Creates a file link
     *
     * @param  \DigitalRiver\ApiSdk\Model\FileLinkRequest $file_link_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createFileLinks'] to see the possible values for this operation
     *
     * @throws \DigitalRiver\ApiSdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     */
    public function createFileLinksWithHttpInfo($file_link_request = null, string $contentType = self::contentTypes['createFileLinks'][0])
    {
        $request = $this->createFileLinksRequest($file_link_request, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\DigitalRiver\ApiSdk\Model\FileLink' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\DigitalRiver\ApiSdk\Model\FileLink' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\DigitalRiver\ApiSdk\Model\FileLink', []),
            ...
            $returnType = '\DigitalRiver\ApiSdk\Model\FileLink';
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\DigitalRiver\ApiSdk\Model\FileLink',
    ...
    /**
     * Operation createFileLinksAsync
     *
     * Creates a file link
     *
     * @param  \DigitalRiver\ApiSdk\Model\FileLinkRequest $file_link_request (optional)
     ...
     */
    public function createFileLinksAsync($file_link_request = null, string $contentType = self::contentTypes['createFileLinks'][0])
    {
        return $this->createFileLinksAsyncWithHttpInfo($file_link_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation createFileLinksAsyncWithHttpInfo
     *
     * Creates a file link
     *
     * @param  \DigitalRiver\ApiSdk\Model\FileLinkRequest $file_link_request (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createFileLinksAsyncWithHttpInfo($file_link_request = null, string $contentType = self::contentTypes['createFileLinks'][0])
    {
        $returnType = '\DigitalRiver\ApiSdk\Model\FileLink';
        $request = $this->createFileLinksRequest($file_link_request, $contentType);
    ...
    /**
     * Create request for operation 'createFileLinks'
     *
     * @param  \DigitalRiver\ApiSdk\Model\FileLinkRequest $file_link_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createFileLinks'] to see the possible values for this operation
     *
     ...
     */
    public function createFileLinksRequest($file_link_request = null, string $contentType = self::contentTypes['createFileLinks'][0])
    {



        $resourcePath = '/file-links';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation deleteFileLinks
     *
     * Deletes a file link by ID.
     *
     * @param  string $id FileLink ID (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['deleteFileLinks'] to see the possible values for this operation
     *
     * @throws \DigitalRiver\ApiSdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function deleteFileLinks($id, string $contentType = self::contentTypes['deleteFileLinks'][0])
    {
        $this->deleteFileLinksWithHttpInfo($id, $contentType);
    }

    /**
     * Operation deleteFileLinksWithHttpInfo
     *
     * Deletes a file link by ID.
     *
     * @param  string $id FileLink ID (required)
     ...
     */
    public function deleteFileLinksWithHttpInfo($id, string $contentType = self::contentTypes['deleteFileLinks'][0])
    {
        $request = $this->deleteFileLinksRequest($id, $contentType);
    ...
    /**
     * Operation deleteFileLinksAsync
     *
     * Deletes a file link by ID.
     *
     * @param  string $id FileLink ID (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteFileLinksAsync($id, string $contentType = self::contentTypes['deleteFileLinks'][0])
    {
        return $this->deleteFileLinksAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation deleteFileLinksAsyncWithHttpInfo
     *
     * Deletes a file link by ID.
     *
     * @param  string $id FileLink ID (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteFileLinksAsyncWithHttpInfo($id, string $contentType = self::contentTypes['deleteFileLinks'][0])
    {
        $returnType = '';
        $request = $this->deleteFileLinksRequest($id, $contentType);
    ...
    /**
     * Create request for operation 'deleteFileLinks'
     *
     * @param  string $id FileLink ID (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['deleteFileLinks'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deleteFileLinksRequest($id, string $contentType = self::contentTypes['deleteFileLinks'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling deleteFileLinks'
            );
        }


        $resourcePath = '/file-links/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @param  string $file_id Only return links with this file identifier. (optional)
     * @param  bool $expired Filter links by expired state. By default, all links are returned. (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['listFileLinks'] to see the possible values for this operation
     *
     * @throws \DigitalRiver\ApiSdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \DigitalRiver\ApiSdk\Model\ListFileLinksResponse|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors
     */
    public function listFileLinks($created_time = null, $ending_before = null, $starting_after = null, $limit = null, $ids = null, $file_id = null, $expired = null, string $contentType = self::contentTypes['listFileLinks'][0])
    {
        list($response) = $this->listFileLinksWithHttpInfo($created_time, $ending_before, $starting_after, $limit, $ids, $file_id, $expired, $contentType);
        return $response;
    }

    /**
     * Operation listFileLinksWithHttpInfo
     *
     * Returns a list of file links
     *
     * @param  array<string,\DateTime> $created_time A filter on the list based on the **createdTime** field. The value can be a string with an ISO-8601 UTC format datetime or it can be a dictionary with the following options:    - **gt**&amp;mdash;return values where the createdTime field is after this timestamp   - **gte**&amp;mdash;return values where the createdTime field is after or equal to this timestamp   - **lt**&amp;mdash;return values where the createdTime field is before this timestamp   - **lte**&amp;mdash;return values where the createdTime field is before or equal to this timestamp (optional)
     ...
     * @return array of \DigitalRiver\ApiSdk\Model\ListFileLinksResponse|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors, HTTP status code, HTTP response headers (array of strings)
     */
    public function listFileLinksWithHttpInfo($created_time = null, $ending_before = null, $starting_after = null, $limit = null, $ids = null, $file_id = null, $expired = null, string $contentType = self::contentTypes['listFileLinks'][0])
    {
        $request = $this->listFileLinksRequest($created_time, $ending_before, $starting_after, $limit, $ids, $file_id, $expired, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\DigitalRiver\ApiSdk\Model\ListFileLinksResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\DigitalRiver\ApiSdk\Model\ListFileLinksResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\DigitalRiver\ApiSdk\Model\ListFileLinksResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\DigitalRiver\ApiSdk\Model\ListFileLinksResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\DigitalRiver\ApiSdk\Model\ListFileLinksResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listFileLinksAsync($created_time = null, $ending_before = null, $starting_after = null, $limit = null, $ids = null, $file_id = null, $expired = null, string $contentType = self::contentTypes['listFileLinks'][0])
    {
        return $this->listFileLinksAsyncWithHttpInfo($created_time, $ending_before, $starting_after, $limit, $ids, $file_id, $expired, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation listFileLinksAsyncWithHttpInfo
     *
     * Returns a list of file links
     *
     * @param  array<string,\DateTime> $created_time A filter on the list based on the **createdTime** field. The value can be a string with an ISO-8601 UTC format datetime or it can be a dictionary with the following options:    - **gt**&amp;mdash;return values where the createdTime field is after this timestamp   - **gte**&amp;mdash;return values where the createdTime field is after or equal to this timestamp   - **lt**&amp;mdash;return values where the createdTime field is before this timestamp   - **lte**&amp;mdash;return values where the createdTime field is before or equal to this timestamp (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listFileLinksAsyncWithHttpInfo($created_time = null, $ending_before = null, $starting_after = null, $limit = null, $ids = null, $file_id = null, $expired = null, string $contentType = self::contentTypes['listFileLinks'][0])
    {
        $returnType = '\DigitalRiver\ApiSdk\Model\ListFileLinksResponse';
        $request = $this->listFileLinksRequest($created_time, $ending_before, $starting_after, $limit, $ids, $file_id, $expired, $contentType);
    ...
    /**
     * Create request for operation 'listFileLinks'
     *
     * @param  array<string,\DateTime> $created_time A filter on the list based on the **createdTime** field. The value can be a string with an ISO-8601 UTC format datetime or it can be a dictionary with the following options:    - **gt**&amp;mdash;return values where the createdTime field is after this timestamp   - **gte**&amp;mdash;return values where the createdTime field is after or equal to this timestamp   - **lt**&amp;mdash;return values where the createdTime field is before this timestamp   - **lte**&amp;mdash;return values where the createdTime field is before or equal to this timestamp (optional)
     * @param  string $ending_before A cursor for use in pagination. The endingBefore parameter is an object ID that defines your place in the list. For instance, if you make a list request and receive 100 objects, starting with xyz your subsequent calls can include endingBefore&#x3D;xyz in order to fetch the previous page of the list. (optional)
     * @param  string $starting_after A cursor for use in pagination. The startingAfter parameter is an object ID that defines your place in the list. For instance, if you make a list request and receive 100 objects, ending with xyz, your subsequent calls can include startingAfter&#x3D;xyz in order to fetch the next page of the list. (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function listFileLinksRequest($created_time = null, $ending_before = null, $starting_after = null, $limit = null, $ids = null, $file_id = null, $expired = null, string $contentType = self::contentTypes['listFileLinks'][0])
    {
        ...
        if ($limit !== null && $limit > 100) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling FileLinksApi.listFileLinks, must be smaller than or equal to 100.');
        }
        if ($limit !== null && $limit < 1) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling FileLinksApi.listFileLinks, must be bigger than or equal to 1.');
        }
    ...
    /**
     * Operation retrieveFileLinks
     *
     * Gets a file link by identifer
     *
     * @param  string $id The identifier of the file link to be retrieved. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['retrieveFileLinks'] to see the possible values for this operation
     *
     * @throws \DigitalRiver\ApiSdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \DigitalRiver\ApiSdk\Model\FileLink|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors
     */
    public function retrieveFileLinks($id, string $contentType = self::contentTypes['retrieveFileLinks'][0])
    {
        list($response) = $this->retrieveFileLinksWithHttpInfo($id, $contentType);
        return $response;
    }

    /**
     * Operation retrieveFileLinksWithHttpInfo
     *
     * Gets a file link by identifer
     *
     * @param  string $id The identifier of the file link to be retrieved. (required)
     ...
     * @return array of \DigitalRiver\ApiSdk\Model\FileLink|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors, HTTP status code, HTTP response headers (array of strings)
     */
    public function retrieveFileLinksWithHttpInfo($id, string $contentType = self::contentTypes['retrieveFileLinks'][0])
    {
        $request = $this->retrieveFileLinksRequest($id, $contentType);
    ...
    /**
     * Operation retrieveFileLinksAsync
     *
     * Gets a file link by identifer
     *
     * @param  string $id The identifier of the file link to be retrieved. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveFileLinksAsync($id, string $contentType = self::contentTypes['retrieveFileLinks'][0])
    {
        return $this->retrieveFileLinksAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation retrieveFileLinksAsyncWithHttpInfo
     *
     * Gets a file link by identifer
     *
     * @param  string $id The identifier of the file link to be retrieved. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveFileLinksAsyncWithHttpInfo($id, string $contentType = self::contentTypes['retrieveFileLinks'][0])
    {
        $returnType = '\DigitalRiver\ApiSdk\Model\FileLink';
        $request = $this->retrieveFileLinksRequest($id, $contentType);
    ...
    /**
     * Create request for operation 'retrieveFileLinks'
     *
     * @param  string $id The identifier of the file link to be retrieved. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['retrieveFileLinks'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function retrieveFileLinksRequest($id, string $contentType = self::contentTypes['retrieveFileLinks'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling retrieveFileLinks'
            );
        }
    ...
    /**
     * Operation updateFileLinks
     *
     * Updates a file link
     *
     * @param  string $id The identifier of the file link to be updated. (required)
     * @param  \DigitalRiver\ApiSdk\Model\UpdateFileLinkRequest $update_file_link_request update_file_link_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['updateFileLinks'] to see the possible values for this operation
     *
     * @throws \DigitalRiver\ApiSdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \DigitalRiver\ApiSdk\Model\FileLink|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors
     */
    public function updateFileLinks($id, $update_file_link_request = null, string $contentType = self::contentTypes['updateFileLinks'][0])
    {
        list($response) = $this->updateFileLinksWithHttpInfo($id, $update_file_link_request, $contentType);
        return $response;
    }

    /**
     * Operation updateFileLinksWithHttpInfo
     *
     * Updates a file link
     *
     * @param  string $id The identifier of the file link to be updated. (required)
     * @param  \DigitalRiver\ApiSdk\Model\UpdateFileLinkRequest $update_file_link_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['updateFileLinks'] to see the possible values for this operation
     *
     * @throws \DigitalRiver\ApiSdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \DigitalRiver\ApiSdk\Model\FileLink|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors|\DigitalRiver\ApiSdk\Model\Errors, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateFileLinksWithHttpInfo($id, $update_file_link_request = null, string $contentType = self::contentTypes['updateFileLinks'][0])
    {
        $request = $this->updateFileLinksRequest($id, $update_file_link_request, $contentType);
    ...
    /**
     * Operation updateFileLinksAsync
     *
     * Updates a file link
     *
     * @param  string $id The identifier of the file link to be updated. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateFileLinksAsync($id, $update_file_link_request = null, string $contentType = self::contentTypes['updateFileLinks'][0])
    {
        return $this->updateFileLinksAsyncWithHttpInfo($id, $update_file_link_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation updateFileLinksAsyncWithHttpInfo
     *
     * Updates a file link
     *
     * @param  string $id The identifier of the file link to be updated. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateFileLinksAsyncWithHttpInfo($id, $update_file_link_request = null, string $contentType = self::contentTypes['updateFileLinks'][0])
    {
        $returnType = '\DigitalRiver\ApiSdk\Model\FileLink';
        $request = $this->updateFileLinksRequest($id, $update_file_link_request, $contentType);
    ...
    /**
     * Create request for operation 'updateFileLinks'
     *
     * @param  string $id The identifier of the file link to be updated. (required)
     * @param  \DigitalRiver\ApiSdk\Model\UpdateFileLinkRequest $update_file_link_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['updateFileLinks'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateFileLinksRequest($id, $update_file_link_request = null, string $contentType = self::contentTypes['updateFileLinks'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling updateFileLinks'
            );
        }
        ...
        // for model (json/xml)
        if (isset($update_file_link_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($update_file_link_request));
            } else {
                $httpBody = $update_file_link_request;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
