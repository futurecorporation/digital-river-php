...
/**
 * ListCountrySpecsResponse Class Doc Comment
 *
 * @category Class
 * @package  DigitalRiver\ApiSdk
 * @author   OpenAPI Generator team
 ...
 */
class ListCountrySpecsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ListCountrySpecsResponse';
    ...
    protected static $openAPITypes = [
        'data' => '\DigitalRiver\ApiSdk\Model\CountrySpecification[]'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \DigitalRiver\ApiSdk\Model\CountrySpecification[]|null
     */
     ...
     * Sets data
     *
     * @param \DigitalRiver\ApiSdk\Model\CountrySpecification[]|null $data data
     *
     * @return self
     */
    public function setData($data)
    {
        ...
        if ((count($data) > 1)) {
            throw new \InvalidArgumentException('invalid value for $data when calling ListCountrySpecsResponse., number of items must be less than or equal to 1.');
        }
        if ((count($data) < 0)) {
            throw new \InvalidArgumentException('invalid length for $data when calling ListCountrySpecsResponse., number of items must be greater than or equal to 0.');
        }
