...
/**
 * TaxIdentifierStateTransitions Class Doc Comment
 *
 * @category Class
 ...
 */
class TaxIdentifierStateTransitions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TaxIdentifierStateTransitions';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('not_valid', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets pending
     *
     * @param \DateTime|null $pending pending
     *
     * @return self
     */
     ...
     * Sets verified
     *
     * @param \DateTime|null $verified verified
     *
     * @return self
     */
     ...
     * Sets not_valid
     *
     * @param \DateTime|null $not_valid not_valid
     *
     * @return self
     */
    public function setNotValid($not_valid)
    {
        if (is_null($not_valid)) {
            array_push($this->openAPINullablesSetToNull, 'not_valid');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('not_valid', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
