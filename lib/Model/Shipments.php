 ...
 */
class Shipments implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Shipments';
    ...
    protected static $openAPITypes = [
        ...
        'packages' => '\DigitalRiver\ApiSdk\Model\Packages[]'
    ];
    ...
    */
     ...
     * Gets packages
     *
     * @return \DigitalRiver\ApiSdk\Model\Packages[]|null
     */
     ...
     * Sets packages
     *
     * @param \DigitalRiver\ApiSdk\Model\Packages[]|null $packages packages
     *
     * @return self
     */
