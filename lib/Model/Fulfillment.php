...
class Fulfillment implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets currency
     *
     * @param string|null $currency A valid [ISO 4217](https://www.iso.org/iso-4217-currency-codes.html) code that represents the currency the distributor is paid in.
     *
     * @return self
     */
