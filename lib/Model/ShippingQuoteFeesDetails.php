...
/**
 * ShippingQuoteFeesDetails Class Doc Comment
 *
 * @category Class
 * @package  DigitalRiver\ApiSdk
 * @author   OpenAPI Generator team
 ...
 */
class ShippingQuoteFeesDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ShippingQuoteFeesDetails';
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name The name of the fee.
     *
     * @return self
     */
     ...
     * Sets amount
     *
     * @param float|null $amount The amount of the fee.
     *
     * @return self
     */
