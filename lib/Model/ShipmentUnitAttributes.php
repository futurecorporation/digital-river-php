...
/**
 * ShipmentUnitAttributes Class Doc Comment
 *
 * @category Class
 ...
 */
class ShipmentUnitAttributes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ShipmentUnitAttributes';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('imei_number', $data ?? [], null);
        $this->setIfExists('sim_card_number', $data ?? [], null);
    }
    ...
    */
    ...
    {
        if (is_null($imei_number)) {
            array_push($this->openAPINullablesSetToNull, 'imei_number');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('imei_number', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    {
        if (is_null($sim_card_number)) {
            array_push($this->openAPINullablesSetToNull, 'sim_card_number');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('sim_card_number', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
