...
class Fees implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'details' => '\DigitalRiver\ApiSdk\Model\FeeDetails[]',
        'amount' => 'float',
        'tax_amount' => 'float'
    ];
    ...
    */
     ...
     * Gets details
     *
     * @return \DigitalRiver\ApiSdk\Model\FeeDetails[]|null
     */
     ...
     * Sets details
     *
     * @param \DigitalRiver\ApiSdk\Model\FeeDetails[]|null $details details
     *
     * @return self
     */
     ...
     * Sets amount
     *
     * @param float|null $amount Total fee amount.
     *
     * @return self
     */
     ...
     * Sets tax_amount
     *
     * @param float|null $tax_amount Total fee tax amount
     *
     * @return self
     */
