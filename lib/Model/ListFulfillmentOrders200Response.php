<?php
/**
 * ListFulfillmentOrders200Response
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * ListFulfillmentOrders200Response Class Doc Comment
 *
 * @category Class
 * @package  DigitalRiver\ApiSdk
 * @author   OpenAPI Generator team
 ...
 */
class ListFulfillmentOrders200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'listFulfillmentOrders_200_response';
    ...
    */
    ...
    public function setData($data)
    {
        ...
        if ((count($data) > 100)) {
            throw new \InvalidArgumentException('invalid value for $data when calling ListFulfillmentOrders200Response., number of items must be less than or equal to 100.');
        }
        if ((count($data) < 0)) {
            throw new \InvalidArgumentException('invalid length for $data when calling ListFulfillmentOrders200Response., number of items must be greater than or equal to 0.');
        }
