 ...
 */
class WEEE implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WEEE';
    ...
    protected static $attributeMap = [
        'weee_registration_id' => 'weeeRegistrationId'
    ];
    ...
    protected static $setters = [
        'weee_registration_id' => 'setWeeeRegistrationId'
    ];
    ...
    protected static $getters = [
        'weee_registration_id' => 'getWeeeRegistrationId'
    ];
    ...
    {
        $this->setIfExists('weee_registration_id', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets weee_registration_id
     *
     * @return string|null
     */
    public function getWeeeRegistrationId()
    {
        return $this->container['weee_registration_id'];
    }

    /**
     * Sets weee_registration_id
     *
     * @param string|null $weee_registration_id The unique identifier assigned to a reseller of record by a country where a fee is required and collected
     *
     * @return self
     */
    public function setWeeeRegistrationId($weee_registration_id)
    {
        if (is_null($weee_registration_id)) {
            throw new \InvalidArgumentException('non-nullable weee_registration_id cannot be null');
        }
        $this->container['weee_registration_id'] = $weee_registration_id;
