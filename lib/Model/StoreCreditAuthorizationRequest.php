...
/**
 * StoreCreditAuthorizationRequest Class Doc Comment
 *
 * @category Class
 * @package  DigitalRiver\ApiSdk
 * @author   OpenAPI Generator team
 ...
 */
class StoreCreditAuthorizationRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StoreCreditAuthorizationRequest';
    ...
    */
     ...
     * Sets session_id
     *
     * @param string|null $session_id The identifier of the checkout session associated with the store credit request.
     *
     * @return self
     */
     ...
     *
     * @param string|null $session_upstream_id The upstream identifier of the checkout session associated with the store credit request.
     *
     * @return self
     */
     ...
     * Sets amount
     *
     * @param float|null $amount The store credit amount.
     *
     * @return self
     */
