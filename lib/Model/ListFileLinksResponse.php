...
/**
 * ListFileLinksResponse Class Doc Comment
 *
 * @category Class
 * @package  DigitalRiver\ApiSdk
 * @author   OpenAPI Generator team
 ...
 */
class ListFileLinksResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ListFileLinksResponse';
    ...
    protected static $openAPITypes = [
        'has_more' => 'bool',
        'data' => '\DigitalRiver\ApiSdk\Model\FileLink[]'
    ];
    ...
    */
     ...
     * Sets data
     *
     * @param \DigitalRiver\ApiSdk\Model\FileLink[]|null $data data
     *
     * @return self
     */
