...
/**
 * DropInCheckoutLinkResponse Class Doc Comment
 *
 * @category Class
 * @package  DigitalRiver\ApiSdk
 * @author   OpenAPI Generator team
 ...
 */
class DropInCheckoutLinkResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DropInCheckoutLinkResponse';
    ...
    */
     ...
     * Sets session_id
     *
     * @param string|null $session_id The session identifier.
     *
     * @return self
     */
