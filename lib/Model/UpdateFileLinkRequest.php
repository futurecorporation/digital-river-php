...
/**
 * UpdateFileLinkRequest Class Doc Comment
 *
 * @category Class
 * @package  DigitalRiver\ApiSdk
 * @author   OpenAPI Generator team
 ...
 */
class UpdateFileLinkRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateFileLinkRequest';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['expires_time'] === null) {
            $invalidProperties[] = "'expires_time' can't be null";
        }
     ...
     * Sets expires_time
     *
     * @param \DateTime $expires_time A future timestamp, after which the link will no longer be usable.
     *
     * @return self
     */
