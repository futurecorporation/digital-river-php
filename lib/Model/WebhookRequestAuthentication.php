...
/**
 * WebhookRequestAuthentication Class Doc Comment
 *
 * @category Class
 * @package  DigitalRiver\ApiSdk
 * @author   OpenAPI Generator team
 ...
 */
class WebhookRequestAuthentication implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WebhookRequest_authentication';
    ...
    */
     ...
     * Sets username
     *
     * @param string|null $username some_user_name
     *
     * @return self
     */
     ...
     * Sets password
     *
     * @param string|null $password some_secure_password
     *
     * @return self
     */
