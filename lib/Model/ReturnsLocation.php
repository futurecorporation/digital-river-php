...
/**
 * ReturnsLocation Class Doc Comment
 *
 * @category Class
 * @package  DigitalRiver\ApiSdk
 * @author   OpenAPI Generator team
 ...
 */
class ReturnsLocation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ReturnsLocation';
    ...
    protected static $openAPITypes = [
        'address' => '\DigitalRiver\ApiSdk\Model\ReturnsAddress',
        'name' => 'string',
        'phone' => 'string',
        'email' => 'string'
    ];
    ...
    */
     ...
     * Gets address
     *
     * @return \DigitalRiver\ApiSdk\Model\ReturnsAddress
     */
     ...
     * Sets address
     *
     * @param \DigitalRiver\ApiSdk\Model\ReturnsAddress $address address
     *
     * @return self
     */
