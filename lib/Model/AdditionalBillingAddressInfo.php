 ...
 */
class AdditionalBillingAddressInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const TITLE_M = 'M';
    public const TITLE_MME = 'Mme';
    public const TITLE_MLLE = 'Mlle';
