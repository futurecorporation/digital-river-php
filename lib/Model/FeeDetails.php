 ...
 */
class FeeDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets amount
     *
     * @param float|null $amount The <code>details[].perUnitAmount</code> multiplied by the <code>quantity</code> of the line item.
     *
     * @return self
     */
     ...
     *
     * @param float|null $per_unit_amount The fee amount per unit.
     *
     * @return self
     */
