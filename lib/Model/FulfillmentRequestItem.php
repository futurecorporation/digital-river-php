...
class FulfillmentRequestItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param string|null $subfulfiller_id The unique identifer of the subfulfiller.
     *
     * @return self
     */
     ...
     * Sets shipping_cost
     *
     * @param float|null $shipping_cost The cost of shipping. If provided, then <code>currency</code> is required.
     *
     * @return self
     */
