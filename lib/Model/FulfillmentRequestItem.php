...
class FulfillmentRequestItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param string|null $subfulfiller_id The unique identifer of the distributor. If you don't provide it, then Digital River’s accounting service won’t have the information it needs to make a payout to the distributor and the fulfillment can't be resolved.
     *
     * @return self
     */
     ...
     * Sets shipping_cost
     *
     * @param float|null $shipping_cost The cost to ship the line item.<br><br> If provided, then <code>currency</code> is required.<br> <br>The <code>shippingCost</code> can't be less then <code>0</code>.
     *
     * @return self
     */
