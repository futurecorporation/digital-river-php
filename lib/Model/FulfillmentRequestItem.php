...
/**
 * FulfillmentRequestItem Class Doc Comment
 *
 * @category Class
 * @package  DigitalRiver\ApiSdk
 * @author   OpenAPI Generator team
 ...
 */
class FulfillmentRequestItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FulfillmentRequestItem';
    ...
    */
     ...
     * Sets quantity
     *
     * @param int|null $quantity The number of items fulfilled. You must provide either this value and/or a value for the <code>cancelQuantity</code> attribute.
     *
     * @return self
     */
     ...
     *
     * @param int|null $cancel_quantity The number of items cancelled. You must provide either this value and/or a value for the <code>quantity</code> attribute.
     *
     * @return self
     */
    public function setCancelQuantity($cancel_quantity)
    {
        if (is_null($cancel_quantity)) {
            array_push($this->openAPINullablesSetToNull, 'cancel_quantity');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('cancel_quantity', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
