...
class WebhookRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'oauth' => '\DigitalRiver\ApiSdk\Model\WebhookRequestOauth',
    ...
    */
     ...
     * Sets enabled
     *
     * @param bool|null $enabled Indicates whether the webhook is enabled and receives notifications.
     *
     * @return self
     */
     ...
     * Sets address
     *
     * @param string $address URL of the webhook endpoint on your server you have set up to receive webhook notifications. Webhook data is sent as JSON in the POST request body. The full event details are included and can be used directly, after parsing the JSON into an Event object.
     *
     * @return self
     */
     ...
     * Gets oauth
     *
     * @return \DigitalRiver\ApiSdk\Model\WebhookRequestOauth|null
     */
     ...
     * Sets oauth
     *
     * @param \DigitalRiver\ApiSdk\Model\WebhookRequestOauth|null $oauth oauth
     *
     * @return self
     */
