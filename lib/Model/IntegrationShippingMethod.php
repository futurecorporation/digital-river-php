...
/**
 * IntegrationShippingMethod Class Doc Comment
 *
 * @category Class
 * @package  DigitalRiver\ApiSdk
 * @author   OpenAPI Generator team
 ...
 */
class IntegrationShippingMethod implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'IntegrationShippingMethod';
    ...
    */
     ...
     * Sets amount
     *
     * @param float $amount The shipping method's cost.
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string $description The shipping method's description.
     *
     * @return self
     */
