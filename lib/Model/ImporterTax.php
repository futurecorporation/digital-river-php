 ...
 */
class ImporterTax implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ImporterTax';
    ...
    */
     ...
     * Sets amount
     *
     * @param float|null $amount The tax amount from the importer of record.
     *
     * @return self
     */
