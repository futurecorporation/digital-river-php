...
/**
 * SalesSummary Class Doc Comment
 *
 * @category Class
 * @package  DigitalRiver\ApiSdk
 * @author   OpenAPI Generator team
 ...
 */
class SalesSummary implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SalesSummary';
    ...
    protected static $attributeMap = [
        ...
        'sales_closing_time' => 'salesClosingTime',
        'currency' => 'currency',
        'amount' => 'amount',
        'payout_id' => 'payoutId',
        'paid' => 'paid',
    ...
    protected static $setters = [
        ...
        'sales_closing_time' => 'setSalesClosingTime',
    ...
    protected static $getters = [
        ...
        'sales_closing_time' => 'getSalesClosingTime',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('sales_closing_time', $data ?? [], null);
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id Unique identifier for the sales summary
     *
     * @return self
     */
     ...
     * Sets created_time
     *
     * @param \DateTime|null $created_time Time at which the sales summary was created
     *
     * @return self
     */
    ...
    /**
     * Gets sales_closing_time
     *
     * @return \DateTime|null
     */
    public function getSalesClosingTime()
    {
        return $this->container['sales_closing_time'];
    }

    /**
     * Sets sales_closing_time
     *
     * @param \DateTime|null $sales_closing_time Time at which the sales summary was closed
     *
     * @return self
     */
    public function setSalesClosingTime($sales_closing_time)
    {
        if (is_null($sales_closing_time)) {
            throw new \InvalidArgumentException('non-nullable sales_closing_time cannot be null');
        }
        $this->container['sales_closing_time'] = $sales_closing_time;
     ...
     * Sets currency
     *
     * @param string|null $currency Three-letter ISO currency code representing the sales summary currency.
     *
     * @return self
     */
     ...
     * Sets amount
     *
     * @param float|null $amount Represents the total sales summary amount.
     *
     * @return self
     */
     ...
     * Sets payout_id
     *
     * @param string|null $payout_id Payout identifier
     *
     * @return self
     */
     ...
     * Sets paid
     *
     * @param bool|null $paid If true, indicates that this sales summary has been paid.
     *
     * @return self
     */
