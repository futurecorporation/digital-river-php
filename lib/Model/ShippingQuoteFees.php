...
/**
 * ShippingQuoteFees Class Doc Comment
 *
 * @category Class
 * @package  DigitalRiver\ApiSdk
 * @author   OpenAPI Generator team
 ...
 */
class ShippingQuoteFees implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ShippingQuoteFees';
    ...
    protected static $openAPITypes = [
        'details' => '\DigitalRiver\ApiSdk\Model\ShippingQuoteFeesDetails[]',
        'amount' => 'float'
    ];
    ...
    */
     ...
     * Gets details
     *
     * @return \DigitalRiver\ApiSdk\Model\ShippingQuoteFeesDetails[]|null
     */
     ...
     * Sets details
     *
     * @param \DigitalRiver\ApiSdk\Model\ShippingQuoteFeesDetails[]|null $details details
     *
     * @return self
     */
     ...
     * Sets amount
     *
     * @param float|null $amount The aggregated amount of assessed fees.
     *
     * @return self
     */
