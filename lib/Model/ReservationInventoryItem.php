 ...
 */
class ReservationInventoryItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setInventoryItemId($inventory_item_id)
    {
        if (is_null($inventory_item_id)) {
            array_push($this->openAPINullablesSetToNull, 'inventory_item_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('inventory_item_id', $nullablesSetToNull);
            if ($index !== FALSE) {
