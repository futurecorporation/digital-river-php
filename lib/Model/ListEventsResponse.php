 ...
 */
class ListEventsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'has_more' => 'bool',
        'data' => '\DigitalRiver\ApiSdk\Model\Event[]'
    ];
    ...
    */
     ...
     * Sets has_more
     *
     * @param bool|null $has_more Indicates whether more elements are available. If <code>false</code> this set represents the end of the list.
     *
     * @return self
     */
     ...
     * Gets data
     *
     * @return \DigitalRiver\ApiSdk\Model\Event[]|null
     */
     ...
     * Sets data
     *
     * @param \DigitalRiver\ApiSdk\Model\Event[]|null $data data
     *
     * @return self
     */
    public function setData($data)
    {
        ...
        if ((count($data) > 100)) {
            throw new \InvalidArgumentException('invalid value for $data when calling ListEventsResponse., number of items must be less than or equal to 100.');
        }
        if ((count($data) < 0)) {
            throw new \InvalidArgumentException('invalid length for $data when calling ListEventsResponse., number of items must be greater than or equal to 0.');
        }
