 ...
 */
class Disclosure implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Disclosure';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id Unique identifier for the disclosure.
     *
     * @return self
     */
     ...
     * Sets created_time
     *
     * @param \DateTime|null $created_time Time when the disclosure was created.
     *
     * @return self
     */
     ...
     * Sets term_id
     *
     * @param string|null $term_id Unique identifier of an existing term.
     *
     * @return self
     */
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 4000)) {
            throw new \InvalidArgumentException('invalid length for $description when calling Disclosure., must be smaller than or equal to 4000.');
        }
