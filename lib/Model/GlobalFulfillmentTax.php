...
/**
 * GlobalFulfillmentTax Class Doc Comment
 *
 * @category Class
 * @package  DigitalRiver\ApiSdk
 * @author   OpenAPI Generator team
 ...
 */
class GlobalFulfillmentTax implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GlobalFulfillmentTax';
    ...
    protected static $openAPITypes = [
        'items' => '\DigitalRiver\ApiSdk\Model\TaxDetail[]',
        'amount' => 'float'
    ];
    ...
    */
     ...
     * Gets items
     *
     * @return \DigitalRiver\ApiSdk\Model\TaxDetail[]|null
     */
     ...
     * Sets items
     *
     * @param \DigitalRiver\ApiSdk\Model\TaxDetail[]|null $items items
     *
     * @return self
     */
