...
/**
 * ListTaxIdentifiers200Response Class Doc Comment
 *
 * @category Class
 * @package  DigitalRiver\ApiSdk
 * @author   OpenAPI Generator team
 ...
 */
class ListTaxIdentifiers200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'listTaxIdentifiers_200_response';
    ...
    protected static $openAPITypes = [
        'has_more' => 'bool',
        'data' => '\DigitalRiver\ApiSdk\Model\CustomerTaxIdentifier[]'
    ];
    ...
    */
     ...
     * Sets has_more
     *
     * @param bool|null $has_more Indicates whether or not there are more elements available after this set. If false this set represents the end of the list.
     *
     * @return self
     */
     ...
     * Sets data
     *
     * @param \DigitalRiver\ApiSdk\Model\CustomerTaxIdentifier[]|null $data data
     *
     * @return self
     */
    public function setData($data)
    {
        ...
        if ((count($data) > 100)) {
            throw new \InvalidArgumentException('invalid value for $data when calling ListTaxIdentifiers200Response., number of items must be less than or equal to 100.');
        }
        if ((count($data) < 0)) {
            throw new \InvalidArgumentException('invalid length for $data when calling ListTaxIdentifiers200Response., number of items must be greater than or equal to 0.');
        }
