 ...
 */
class SubscriptionItems implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param float|null $aggregate_price Gets or sets the aggregate price
     *
     * @return self
     */
    public function setAggregatePrice($aggregate_price)
    {
        if (is_null($aggregate_price)) {
            array_push($this->openAPINullablesSetToNull, 'aggregate_price');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('aggregate_price', $nullablesSetToNull);
            if ($index !== FALSE) {
