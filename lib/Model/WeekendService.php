...
/**
 * WeekendService Class Doc Comment
 *
 * @category Class
 * @package  DigitalRiver\ApiSdk
 * @author   OpenAPI Generator team
 ...
 */
class WeekendService implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WeekendService';
    ...
    */
     ...
     *
     * @param bool|null $saturday_delivery If <code>true</code>, then delivery will be scheduled for Saturday and an additional fee is charged for the service.  If <code>false</code>, then delivery on that day is not available or it is available but additional fees are not collected. In this case, check <code>dayOfWeek</code> to determine if it's a Saturday delivery.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $sunday_delivery If <code>true</code>, then delivery will be scheduled for Sunday and an additional fee is charged for the service.  If <code>false</code>, then delivery on that day is not available or it is available but additional fees are not collected. In this case, check <code>dayOfWeek</code> to determine if it's a Sunday delivery.
     *
     * @return self
     */
