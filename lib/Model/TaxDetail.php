...
class TaxDetail implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('authority_type', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['authority_type'] === null) {
            $invalidProperties[] = "'authority_type' can't be null";
        }
     ...
     * Sets authority_type
     *
     * @param string $authority_type authority_type
     *
     * @return self
     */
    public function setAuthorityType($authority_type)
    {
        if (is_null($authority_type)) {
            throw new \InvalidArgumentException('non-nullable authority_type cannot be null');
        }
