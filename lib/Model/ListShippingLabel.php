...
/**
 * ListShippingLabel Class Doc Comment
 *
 * @category Class
 * @package  DigitalRiver\ApiSdk
 * @author   OpenAPI Generator team
 ...
 */
class ListShippingLabel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ListShippingLabel';
    ...
    protected static $openAPITypes = [
        'has_more' => 'bool',
        'data' => '\DigitalRiver\ApiSdk\Model\ShippingLabelResponse[]'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \DigitalRiver\ApiSdk\Model\ShippingLabelResponse[]|null
     */
     ...
     * Sets data
     *
     * @param \DigitalRiver\ApiSdk\Model\ShippingLabelResponse[]|null $data data
     *
     * @return self
     */
    public function setData($data)
    {
        ...
        if ((count($data) > 100)) {
            throw new \InvalidArgumentException('invalid value for $data when calling ListShippingLabel., number of items must be less than or equal to 100.');
        }
        if ((count($data) < 0)) {
            throw new \InvalidArgumentException('invalid length for $data when calling ListShippingLabel., number of items must be greater than or equal to 0.');
        }
