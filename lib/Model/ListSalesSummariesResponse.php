...
/**
 * ListSalesSummariesResponse Class Doc Comment
 *
 * @category Class
 * @package  DigitalRiver\ApiSdk
 * @author   OpenAPI Generator team
 ...
 */
class ListSalesSummariesResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ListSalesSummariesResponse';
    ...
    protected static $openAPITypes = [
        'has_more' => 'bool',
        'data' => '\DigitalRiver\ApiSdk\Model\SalesSummary[]'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \DigitalRiver\ApiSdk\Model\SalesSummary[]|null
     */
     ...
     * Sets data
     *
     * @param \DigitalRiver\ApiSdk\Model\SalesSummary[]|null $data data
     *
     * @return self
     */
    public function setData($data)
    {
        ...
        if ((count($data) > 100)) {
            throw new \InvalidArgumentException('invalid value for $data when calling ListSalesSummariesResponse., number of items must be less than or equal to 100.');
        }
        if ((count($data) < 0)) {
            throw new \InvalidArgumentException('invalid length for $data when calling ListSalesSummariesResponse., number of items must be greater than or equal to 0.');
        }
