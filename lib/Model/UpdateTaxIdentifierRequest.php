...
/**
 * UpdateTaxIdentifierRequest Class Doc Comment
 *
 * @category Class
 * @package  DigitalRiver\ApiSdk
 * @author   OpenAPI Generator team
 ...
 */
class UpdateTaxIdentifierRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateTaxIdentifierRequest';
    ...
    */
     ...
     * Sets customer_id
     *
     * @param string $customer_id The ID of an existing customer.
     *
     * @return self
     */
