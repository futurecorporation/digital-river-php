...
class ListSubscriptionsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'has_more' => 'bool',
        'data' => '\DigitalRiver\ApiSdk\Model\Subscription[]'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \DigitalRiver\ApiSdk\Model\Subscription[]|null
     */
     ...
     * Sets data
     *
     * @param \DigitalRiver\ApiSdk\Model\Subscription[]|null $data data
     *
     * @return self
     */
    public function setData($data)
    {
        ...
        if ((count($data) > 100)) {
            throw new \InvalidArgumentException('invalid value for $data when calling ListSubscriptionsResponse., number of items must be less than or equal to 100.');
        }
        if ((count($data) < 0)) {
            throw new \InvalidArgumentException('invalid length for $data when calling ListSubscriptionsResponse., number of items must be greater than or equal to 0.');
        }
