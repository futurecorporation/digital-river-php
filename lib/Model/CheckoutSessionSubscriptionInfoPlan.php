<?php
/**
 * CheckoutSessionSubscriptionInfoPlan
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * CheckoutSessionSubscriptionInfoPlan Class Doc Comment
 *
 * @category Class
 * @package  DigitalRiver\ApiSdk
 * @author   OpenAPI Generator team
 ...
 */
class CheckoutSessionSubscriptionInfoPlan implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CheckoutSessionSubscriptionInfo_plan';
    ...
    */
     ...
     * Sets interval
     *
     * @param string|null $interval The supported billing intervals
     *
     * @return self
     */
     ...
     * Sets interval_count
     *
     * @param int|null $interval_count How often the customer is billed per the unit of time specified by <code>interval</code> (e.g. every 3 months).
     *
     * @return self
     */
