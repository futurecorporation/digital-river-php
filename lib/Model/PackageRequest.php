...
/**
 * PackageRequest Class Doc Comment
 *
 * @category Class
 * @package  DigitalRiver\ApiSdk
 * @author   OpenAPI Generator team
 ...
 */
class PackageRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PackageRequest';
    ...
    */
     ...
     * Sets weight
     *
     * @param int $weight The box’s weight.
     *
     * @return self
     */
     ...
     * Sets weight_unit
     *
     * @param string $weight_unit The box’s weight unit.
     *
     * @return self
     */
