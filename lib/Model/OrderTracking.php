...
/**
 * OrderTracking Class Doc Comment
 *
 * @category Class
 * @package  DigitalRiver\ApiSdk
 * @author   OpenAPI Generator team
 ...
 */
class OrderTracking implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrderTracking';
    ...
    protected static $openAPITypes = [
        ...
        'shipments' => '\DigitalRiver\ApiSdk\Model\Tracking[]'
    ];
    ...
    */
     ...
     * Sets shipments
     *
     * @param \DigitalRiver\ApiSdk\Model\Tracking[]|null $shipments shipments
     *
     * @return self
     */
