...
class Errors implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'type' => 'string',
        'errors' => '\DigitalRiver\ApiSdk\Model\Error[]'
    ];
    ...
    public const TYPE_REQUEST_TIMEOUT = 'request_timeout';
    ...
    public const TYPE_TOO_MANY_REQUESTS = 'too_many_requests';
    public const TYPE_METHOD_NOT_ALLOWED = 'method_not_allowed';
    public const TYPE_NOT_ACCEPTABLE = 'not_acceptable';
    public const TYPE_FORBIDDEN = 'forbidden';
    public const TYPE_BAD_GATEWAY = 'bad_gateway';
    ...
    */
     ...
     * Gets errors
     *
     * @return \DigitalRiver\ApiSdk\Model\Error[]|null
     */
     ...
     * Sets errors
     *
     * @param \DigitalRiver\ApiSdk\Model\Error[]|null $errors errors
     *
     * @return self
     */
