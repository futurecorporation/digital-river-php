 ...
 */
class UnitAttributes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setImeiNumber($imei_number)
    {
        if (is_null($imei_number)) {
            throw new \InvalidArgumentException('non-nullable imei_number cannot be null');
        }
    ...
    public function setSimCardNumber($sim_card_number)
    {
        if (is_null($sim_card_number)) {
            throw new \InvalidArgumentException('non-nullable sim_card_number cannot be null');
        }
