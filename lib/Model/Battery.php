 ...
 */
class Battery implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('chemical_system', $data ?? [], null);
        $this->setIfExists('iec_code', $data ?? [], null);
    }
    ...
    */
    ...
    {
        if (is_null($chemical_system)) {
            throw new \InvalidArgumentException('non-nullable chemical_system cannot be null');
        }
    ...
    {
        if (is_null($iec_code)) {
            throw new \InvalidArgumentException('non-nullable iec_code cannot be null');
        }
