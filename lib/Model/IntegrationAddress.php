...
/**
 * IntegrationAddress Class Doc Comment
 *
 * @category Class
 * @package  DigitalRiver\ApiSdk
 * @author   OpenAPI Generator team
 ...
 */
class IntegrationAddress implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'IntegrationAddress';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('additional_address_info', $data ?? [], null);
    }
    ...
    */
    ...
    {
        if (is_null($additional_address_info)) {
            throw new \InvalidArgumentException('non-nullable additional_address_info cannot be null');
        }
