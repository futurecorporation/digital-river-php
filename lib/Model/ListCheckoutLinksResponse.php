...
/**
 * ListCheckoutLinksResponse Class Doc Comment
 *
 * @category Class
 * @package  DigitalRiver\ApiSdk
 * @author   OpenAPI Generator team
 ...
 */
class ListCheckoutLinksResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ListCheckoutLinksResponse';
    ...
    protected static $openAPITypes = [
        'has_more' => 'bool',
        'data' => '\DigitalRiver\ApiSdk\Model\CheckoutLinkDetails[]'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \DigitalRiver\ApiSdk\Model\CheckoutLinkDetails[]|null
     */
     ...
     * Sets data
     *
     * @param \DigitalRiver\ApiSdk\Model\CheckoutLinkDetails[]|null $data data
     *
     * @return self
     */
    public function setData($data)
    {
        ...
        if ((count($data) > 100)) {
            throw new \InvalidArgumentException('invalid value for $data when calling ListCheckoutLinksResponse., number of items must be less than or equal to 100.');
        }
        if ((count($data) < 0)) {
            throw new \InvalidArgumentException('invalid length for $data when calling ListCheckoutLinksResponse., number of items must be greater than or equal to 0.');
        }
