...
/**
 * InvoiceItemRequest Class Doc Comment
 *
 * @category Class
 * @package  DigitalRiver\ApiSdk
 * @author   OpenAPI Generator team
 ...
 */
class InvoiceItemRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InvoiceItemRequest';
    ...
    */
     ...
     * Sets price
     *
     * @param float|null $price The price of an item. You are required to provide this parameter or <code>aggregatePrice</code>.
     *
     * @return self
     */
     ...
     *
     * @param float|null $aggregate_price The total price of multiple items. You are required to provide this parameter or <code>price</code>.
     *
     * @return self
     */
