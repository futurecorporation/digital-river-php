 ...
 */
class SellingEntity implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SellingEntity';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id The identifier of the selling entity.
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name The name of the selling entity.
     *
     * @return self
     */
