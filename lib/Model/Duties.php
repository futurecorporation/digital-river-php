 ...
 */
class Duties implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Duties';
    ...
    */
     ...
     * Sets amount
     *
     * @param float|null $amount The duty amount for the item.
     *
     * @return self
     */
