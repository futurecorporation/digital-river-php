 ...
 */
class StateTransitions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setDiscontinued($discontinued)
    {
        if (is_null($discontinued)) {
            array_push($this->openAPINullablesSetToNull, 'discontinued');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('discontinued', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    public function setDeactivated($deactivated)
    {
        if (is_null($deactivated)) {
            array_push($this->openAPINullablesSetToNull, 'deactivated');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('deactivated', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
