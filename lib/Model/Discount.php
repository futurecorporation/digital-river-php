...
class Discount implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets amount_off
     *
     * @param float|null $amount_off The discount expressed as an amount.
     *
     * @return self
     */
     ...
     * Sets percent_off
     *
     * @param float|null $percent_off The discount expressed as a percentage.
     *
     * @return self
     */
    public function setPercentOff($percent_off)
    {
        ...
        if (($percent_off > 100.0)) {
            throw new \InvalidArgumentException('invalid value for $percent_off when calling Discount., must be smaller than or equal to 100.0.');
        }
        if (($percent_off < 0.01)) {
            throw new \InvalidArgumentException('invalid value for $percent_off when calling Discount., must be bigger than or equal to 0.01.');
        }
